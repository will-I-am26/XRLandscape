...
{
float l9_7=l9_5.x;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_8=l9_7;
float l9_9=l9_5.y;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_10=l9_9;
vec2 l9_11;
float l9_12;
...
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_14=l9_8;
float l9_15=1.0;
sc_ClampUV(l9_14,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_13,l9_15);
float l9_16=l9_14;
float l9_17=l9_15;
bool l9_18;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_18=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_18=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_19=l9_10;
float l9_20=l9_17;
sc_ClampUV(l9_19,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_18,l9_20);
l9_12=l9_20;
...
#endif
vec2 l9_21=sc_TransformUV(l9_11,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_22=l9_21.x;
float l9_23=l9_12;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_23);
float l9_24=l9_21.y;
float l9_25=l9_23;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_25);
float l9_26=l9_25;
vec3 l9_27=sc_SamplingCoordsViewToGlobal(vec2(l9_22,l9_24),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_28=texture(planet_refl_mapArrSC,l9_27,0.0);
vec4 l9_29;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_29=mix(planet_refl_mapBorderColor,l9_28,vec4(l9_26));
}
#else
{
l9_29=l9_28;
...
{
float l9_30=l9_5.x;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_31=l9_30;
float l9_32=l9_5.y;
sc_SoftwareWrapEarly(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_33=l9_32;
vec2 l9_34;
float l9_35;
#if (SC_USE_UV_MIN_MAX_planet_refl_map)
...
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_36=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_36=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_37=l9_31;
float l9_38=1.0;
sc_ClampUV(l9_37,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_36,l9_38);
float l9_39=l9_37;
float l9_40=l9_38;
bool l9_41;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_41=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_41=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_42=l9_33;
float l9_43=l9_40;
sc_ClampUV(l9_42,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_41,l9_43);
l9_35=l9_43;
...
#endif
vec2 l9_44=sc_TransformUV(l9_34,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_45=l9_44.x;
float l9_46=l9_35;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_46);
float l9_47=l9_44.y;
float l9_48=l9_46;
sc_SoftwareWrapLate(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_48);
float l9_49=l9_48;
vec3 l9_50=sc_SamplingCoordsViewToGlobal(vec2(l9_45,l9_47),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_51=texture(planet_refl_map,l9_50.xy,0.0);
vec4 l9_52;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_52=mix(planet_refl_mapBorderColor,l9_51,vec4(l9_49));
}
#else
{
l9_52=l9_51;
...
vec4 l9_53=(vec4(reflIntensity)*l9_6)+param_10;
vec2 l9_54=Port_Import_N060-Port_Import_N058;
vec4 l9_55=vec4(l9_53.x,l9_53.y,l9_53.z,vec4(0.0).w);
l9_55.w=mix(vec4(l9_53.w),Port_Input1_N029,mix(Port_Import_N038,Port_Import_N031,vec4(smoothstep(Port_Input0_N066,Port_Input1_N066,clamp((dot((((((((Globals.Surface_UVCoord0-vec2(Port_RangeMinA_N033))/vec2(Port_RangeMaxA_N033-Port_RangeMinA_N033))*(Port_RangeMaxB_N033-Port_RangeMinB_N033))+vec2(Port_RangeMinB_N033))-Port_Center_N047)*Globals.Surface_UVCoord0)+Port_Center_N047)-Port_Import_N058,l9_54)/dot(l9_54,l9_54))+0.001,Port_Input1_N065+0.001,Port_Input2_N065+0.001)-0.001)))).x;
Value1=l9_55;
Result=Value1;
}
#else
...
N15_NormalSpace=1;
N15_Normal=Port_Import_N013;
vec3 l9_56=N15_Normal;
vec3 l9_57;
if (N15_NormalSpace==1)
{
l9_57=normalize(mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*l9_56);
}
else
{
l9_57=l9_56;
}
vec3 l9_58=normalize(-Globals.ViewDirWS);
vec3 l9_59=normalize(cross(l9_58,sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz));
vec3 l9_60=cross(l9_59,l9_58);
N15_ReflectionUV=((mat3(vec3(l9_59.x,l9_60.x,l9_58.x),vec3(l9_59.y,l9_60.y,l9_58.y),vec3(l9_59.z,l9_60.z,l9_58.z))*l9_57).xy*0.5)+vec2(0.5);
vec2 l9_61=N15_ReflectionUV;
vec4 l9_62;
#if (planet_refl_mapLayout==2)
{
float l9_63=l9_61.x;
sc_SoftwareWrapEarly(l9_63,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_64=l9_63;
float l9_65=l9_61.y;
sc_SoftwareWrapEarly(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_66=l9_65;
vec2 l9_67;
float l9_68;
#if (SC_USE_UV_MIN_MAX_planet_refl_map)
...
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_69=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_69=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_70=l9_64;
float l9_71=1.0;
sc_ClampUV(l9_70,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_69,l9_71);
float l9_72=l9_70;
float l9_73=l9_71;
bool l9_74;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_74=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_74=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_75=l9_66;
float l9_76=l9_73;
sc_ClampUV(l9_75,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_74,l9_76);
l9_68=l9_76;
...
#endif
vec2 l9_77=sc_TransformUV(l9_67,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_78=l9_77.x;
float l9_79=l9_68;
sc_SoftwareWrapLate(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_79);
float l9_80=l9_77.y;
float l9_81=l9_79;
sc_SoftwareWrapLate(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_81);
float l9_82=l9_81;
vec3 l9_83=sc_SamplingCoordsViewToGlobal(vec2(l9_78,l9_80),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_84=texture(planet_refl_mapArrSC,l9_83,0.0);
vec4 l9_85;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_85=mix(planet_refl_mapBorderColor,l9_84,vec4(l9_82));
}
#else
{
l9_85=l9_84;
...
{
float l9_86=l9_61.x;
sc_SoftwareWrapEarly(l9_86,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_87=l9_86;
float l9_88=l9_61.y;
sc_SoftwareWrapEarly(l9_88,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_89=l9_88;
vec2 l9_90;
float l9_91;
#if (SC_USE_UV_MIN_MAX_planet_refl_map)
...
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_92=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_92=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_93=l9_87;
float l9_94=1.0;
sc_ClampUV(l9_93,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_92,l9_94);
float l9_95=l9_93;
float l9_96=l9_94;
bool l9_97;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_97=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_97=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_98=l9_89;
float l9_99=l9_96;
sc_ClampUV(l9_98,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_97,l9_99);
l9_91=l9_99;
...
#endif
vec2 l9_100=sc_TransformUV(l9_90,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_101=l9_100.x;
float l9_102=l9_91;
sc_SoftwareWrapLate(l9_101,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_102);
float l9_103=l9_100.y;
float l9_104=l9_102;
sc_SoftwareWrapLate(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_104);
float l9_105=l9_104;
vec3 l9_106=sc_SamplingCoordsViewToGlobal(vec2(l9_101,l9_103),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_107=texture(planet_refl_map,l9_106.xy,0.0);
vec4 l9_108;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_108=mix(planet_refl_mapBorderColor,l9_107,vec4(l9_105));
}
#else
{
l9_108=l9_107;
...
Default=(vec4(reflIntensity)*l9_62)+param_22;
Result=Default;
}
#endif
}
...
float l9_33=l9_32.x;
float l9_34=l9_23;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_34);
float l9_35=l9_32.y;
float l9_36=l9_34;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_36);
float l9_37=l9_36;
...
#endif
vec3 l9_64=mix(l9_16.xyz,(l9_17.xyz*l9_16.xyz).xyz,vec3(l9_17.w));
...
{
l9_70=clamp(l9_16.w*2.0,0.0,1.0);
}
#else
{
float l9_71;
...
{
l9_71=clamp(dot(l9_65.xyz,vec3(l9_16.w)),0.0,1.0);
}
#else
{
float l9_72;
...
{
l9_73=(1.0-dot(l9_65.xyz,vec3(0.33333001)))*l9_16.w;
}
#else
{
float l9_74;
...
{
l9_74=(1.0-clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0))*l9_16.w;
}
#else
{
float l9_75;
...
{
l9_75=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0)*l9_16.w;
}
#else
{
float l9_76;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_77=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0)*l9_16.w;
}
#else
{
float l9_78;
...
{
l9_78=dot(l9_65.xyz,vec3(0.33333001))*l9_16.w;
}
#else
{
float l9_79;
...
#endif
vec3 l9_92=mix(l9_90.xyz,definedBlend(l9_90.xyz,l9_65.xyz).xyz,vec3(l9_16.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_94=vec4(mix(vec3(1.0),l9_65.xyz,vec3(l9_16.w)),l9_16.w);
}
#else
{
vec4 l9_95;
