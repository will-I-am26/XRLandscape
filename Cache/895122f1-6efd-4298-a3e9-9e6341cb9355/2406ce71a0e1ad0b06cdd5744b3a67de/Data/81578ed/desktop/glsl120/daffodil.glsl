...
//spec_const bool uv2EnableAnimation 104 0
//spec_const bool uv3EnableAnimation 105 0
...
#endif
vec3 l9_110=mix(vec3(0.0,0.0,1.0),l9_77.xyz,vec3(Port_Strength1_N200))+vec3(0.0,0.0,1.0);
