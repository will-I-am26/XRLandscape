...
//spec_const bool SC_USE_CLAMP_TO_BORDER_IconTex 33 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 34 0
//spec_const bool SC_USE_UV_MIN_MAX_IconTex 35 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 36 0
//spec_const bool SC_USE_UV_TRANSFORM_IconTex 37 0
...
//spec_const int IconTexLayout 80 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_IconTex 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_IconTex 83 -1
...
vec2 l9_3;
Node14_Rotate_Coords(l9_0,Port_Rotation_N014,Port_Center_N014,l9_3,l9_2);
vec2 l9_4=l9_3;
vec2 l9_5=l9_4+Port_Offset_N013;
float l9_6=l9_5.x;
float l9_7=l9_5.y;
...
float l9_10=Port_Input0_N008-CurrSize;
vec3 l9_11;
if ((float(l9_9<l9_10)*1.0)!=0.0)
{
l9_11=LoadingColor.xyz;
}
else
{
vec2 l9_12;
Node14_Rotate_Coords(l9_0,Port_Rotation_N014,Port_Center_N014,l9_12,l9_2);
vec2 l9_13=l9_12;
vec2 l9_14=l9_13+Port_Offset_N013;
float l9_15=l9_14.x;
float l9_16=l9_14.y;
float l9_17=(l9_15*l9_15)+(l9_16*l9_16);
float l9_18;
if (l9_17<=0.0)
{
l9_18=0.0;
...
bool l9_19=l9_18<l9_10;
bool l9_20=l9_18>(Port_Input0_N018+CurrSize);
bool l9_21=(float(l9_19)*1.0)!=0.0;
bool l9_22;
if (!l9_21)
{
l9_22=(float(l9_20)*1.0)!=0.0;
}
else
{
l9_22=l9_21;
...
bool l9_24=((1.0-l9_23)*1.0)!=0.0;
bool l9_25;
if (l9_24)
{
l9_25=(float(atan(l9_16,l9_15)<=((((Amount-Port_RangeMinA_N010)/((Port_RangeMaxA_N010-Port_RangeMinA_N010)+1e-06))*(Port_RangeMaxB_N010-Port_RangeMinB_N010))+Port_RangeMinB_N010))*1.0)!=0.0;
}
else
{
l9_25=l9_24;
...
vec3 l9_26;
if ((float(l9_25)*1.0)!=0.0)
{
l9_26=LoadingColor.xyz;
}
else
{
l9_26=StartColor.xyz;
}
l9_11=l9_26;
}
vec2 param_3;
Node14_Rotate_Coords(l9_0,Port_Rotation_N014,Port_Center_N014,param_3,l9_2);
vec2 l9_27=param_3;
vec2 l9_28=l9_27+Port_Offset_N013;
float l9_29=l9_28.x;
float l9_30=l9_28.y;
float l9_31=(l9_29*l9_29)+(l9_30*l9_30);
float l9_32;
if (l9_31<=0.0)
{
l9_32=0.0;
...
bool l9_33=l9_32<l9_10;
bool l9_34=l9_32>(Port_Input0_N018+CurrSize);
bool l9_35=(float(l9_33)*1.0)!=0.0;
bool l9_36;
if (!l9_35)
{
l9_36=(float(l9_34)*1.0)!=0.0;
}
else
{
l9_36=l9_35;
}
float l9_37=float(l9_36);
float l9_38;
if ((float(CurrSize>=StartSize)*1.0)!=0.0)
{
vec2 l9_39=l9_0-Port_Center_N026;
vec2 l9_40=(l9_39*vec2((((CurrSize-StartSize)/((Port_RangeMaxA_N029-StartSize)+1e-06))*(Port_RangeMaxB_N029-Port_RangeMinB_N029))+Port_RangeMinB_N029))+Port_Center_N026;
vec4 l9_41;
#if (IconTexLayout==2)
{
bool l9_42=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0));
float l9_43=l9_40.x;
sc_SoftwareWrapEarly(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x);
float l9_44=l9_43;
float l9_45=l9_40.y;
sc_SoftwareWrapEarly(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y);
float l9_46=l9_45;
vec2 l9_47;
float l9_48;
...
{
l9_49=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x==3;
}
#else
{
l9_49=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_50=l9_44;
float l9_51=1.0;
sc_ClampUV(l9_50,IconTexUvMinMax.x,IconTexUvMinMax.z,l9_49,l9_51);
float l9_52=l9_50;
float l9_53=l9_51;
bool l9_54;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_54=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y==3;
}
#else
{
l9_54=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_55=l9_46;
float l9_56=l9_53;
sc_ClampUV(l9_55,IconTexUvMinMax.y,IconTexUvMinMax.w,l9_54,l9_56);
l9_48=l9_56;
...
#endif
vec2 l9_57=sc_TransformUV(l9_47,(int(SC_USE_UV_TRANSFORM_IconTex)!=0),IconTexTransform);
float l9_58=l9_57.x;
float l9_59=l9_48;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x,l9_42,l9_59);
float l9_60=l9_57.y;
float l9_61=l9_59;
sc_SoftwareWrapLate(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y,l9_42,l9_61);
float l9_62=l9_61;
vec3 l9_63=sc_SamplingCoordsViewToGlobal(vec2(l9_58,l9_60),IconTexLayout,IconTexGetStereoViewIndex());
vec4 l9_64=texture(IconTexArrSC,l9_63,0.0);
vec4 l9_65;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_65=mix(IconTexBorderColor,l9_64,vec4(l9_62));
}
#else
{
l9_65=l9_64;
...
#else
{
bool l9_66=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0));
float l9_67=l9_40.x;
sc_SoftwareWrapEarly(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x);
float l9_68=l9_67;
float l9_69=l9_40.y;
sc_SoftwareWrapEarly(l9_69,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y);
float l9_70=l9_69;
vec2 l9_71;
float l9_72;
#if (SC_USE_UV_MIN_MAX_IconTex)
...
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_73=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x==3;
}
#else
{
l9_73=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_74=l9_68;
float l9_75=1.0;
sc_ClampUV(l9_74,IconTexUvMinMax.x,IconTexUvMinMax.z,l9_73,l9_75);
float l9_76=l9_74;
float l9_77=l9_75;
bool l9_78;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_78=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y==3;
}
#else
{
l9_78=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_79=l9_70;
float l9_80=l9_77;
sc_ClampUV(l9_79,IconTexUvMinMax.y,IconTexUvMinMax.w,l9_78,l9_80);
l9_72=l9_80;
...
#endif
vec2 l9_81=sc_TransformUV(l9_71,(int(SC_USE_UV_TRANSFORM_IconTex)!=0),IconTexTransform);
float l9_82=l9_81.x;
float l9_83=l9_72;
sc_SoftwareWrapLate(l9_82,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x,l9_66,l9_83);
float l9_84=l9_81.y;
float l9_85=l9_83;
sc_SoftwareWrapLate(l9_84,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y,l9_66,l9_85);
float l9_86=l9_85;
vec3 l9_87=sc_SamplingCoordsViewToGlobal(vec2(l9_82,l9_84),IconTexLayout,IconTexGetStereoViewIndex());
vec4 l9_88=texture(IconTex,l9_87.xy,0.0);
vec4 l9_89;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_89=mix(IconTexBorderColor,l9_88,vec4(l9_86));
}
#else
{
l9_89=l9_88;
...
{
vec2 l9_90=l9_0-Port_Center_N026;
vec2 l9_91=(l9_90*vec2((((CurrSize-StartSize)/((Port_RangeMaxA_N029-StartSize)+1e-06))*(Port_RangeMaxB_N029-Port_RangeMinB_N029))+Port_RangeMinB_N029))+Port_Center_N026;
vec4 l9_92;
#if (IconTexLayout==2)
{
bool l9_93=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0));
float l9_94=l9_91.x;
sc_SoftwareWrapEarly(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x);
float l9_95=l9_94;
float l9_96=l9_91.y;
sc_SoftwareWrapEarly(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y);
float l9_97=l9_96;
vec2 l9_98;
float l9_99;
#if (SC_USE_UV_MIN_MAX_IconTex)
...
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_100=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x==3;
}
#else
{
l9_100=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_101=l9_95;
float l9_102=1.0;
sc_ClampUV(l9_101,IconTexUvMinMax.x,IconTexUvMinMax.z,l9_100,l9_102);
float l9_103=l9_101;
float l9_104=l9_102;
bool l9_105;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_105=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y==3;
}
#else
{
l9_105=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_106=l9_97;
float l9_107=l9_104;
sc_ClampUV(l9_106,IconTexUvMinMax.y,IconTexUvMinMax.w,l9_105,l9_107);
l9_99=l9_107;
...
#endif
vec2 l9_108=sc_TransformUV(l9_98,(int(SC_USE_UV_TRANSFORM_IconTex)!=0),IconTexTransform);
float l9_109=l9_108.x;
float l9_110=l9_99;
sc_SoftwareWrapLate(l9_109,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x,l9_93,l9_110);
float l9_111=l9_108.y;
float l9_112=l9_110;
sc_SoftwareWrapLate(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y,l9_93,l9_112);
float l9_113=l9_112;
vec3 l9_114=sc_SamplingCoordsViewToGlobal(vec2(l9_109,l9_111),IconTexLayout,IconTexGetStereoViewIndex());
vec4 l9_115=texture(IconTexArrSC,l9_114,0.0);
vec4 l9_116;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_116=mix(IconTexBorderColor,l9_115,vec4(l9_113));
}
#else
{
l9_116=l9_115;
...
#else
{
bool l9_117=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0));
float l9_118=l9_91.x;
sc_SoftwareWrapEarly(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x);
float l9_119=l9_118;
float l9_120=l9_91.y;
sc_SoftwareWrapEarly(l9_120,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y);
float l9_121=l9_120;
vec2 l9_122;
float l9_123;
#if (SC_USE_UV_MIN_MAX_IconTex)
...
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_124=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x==3;
}
#else
{
l9_124=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_125=l9_119;
float l9_126=1.0;
sc_ClampUV(l9_125,IconTexUvMinMax.x,IconTexUvMinMax.z,l9_124,l9_126);
float l9_127=l9_125;
float l9_128=l9_126;
bool l9_129;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_129=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y==3;
}
#else
{
l9_129=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_130=l9_121;
float l9_131=l9_128;
sc_ClampUV(l9_130,IconTexUvMinMax.y,IconTexUvMinMax.w,l9_129,l9_131);
l9_123=l9_131;
...
#endif
vec2 l9_132=sc_TransformUV(l9_122,(int(SC_USE_UV_TRANSFORM_IconTex)!=0),IconTexTransform);
float l9_133=l9_132.x;
float l9_134=l9_123;
sc_SoftwareWrapLate(l9_133,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x,l9_117,l9_134);
float l9_135=l9_132.y;
float l9_136=l9_134;
sc_SoftwareWrapLate(l9_135,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y,l9_117,l9_136);
float l9_137=l9_136;
vec3 l9_138=sc_SamplingCoordsViewToGlobal(vec2(l9_133,l9_135),IconTexLayout,IconTexGetStereoViewIndex());
vec4 l9_139=texture(IconTex,l9_138.xy,0.0);
vec4 l9_140;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_140=mix(IconTexBorderColor,l9_139,vec4(l9_137));
}
#else
{
l9_140=l9_139;
...
#endif
l9_38=(vec2(l9_92.w)*vec2((((CurrSize-Port_RangeMinA_N032)/((StartSize-Port_RangeMinA_N032)+1e-06))*(Port_RangeMaxB_N032-Port_RangeMinB_N032))+Port_RangeMinB_N032)).x;
}
float l9_141=(1.0-l9_37)+l9_38;
vec4 l9_142=vec4(l9_11.x,l9_11.y,l9_11.z,vec4(0.0).w);
l9_142.w=l9_141;
...
{
l9_165=1-sc_GetStereoViewIndex();
}
#else
{
l9_165=sc_GetStereoViewIndex();
}
#endif
vec4 l9_166;
#if (sc_ScreenTextureLayout==2)
{
l9_166=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_164,sc_ScreenTextureLayout,l9_165),0.0);
}
#else
{
l9_166=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_164,sc_ScreenTextureLayout,l9_165).xy,0.0);
}
#endif
l9_160=l9_166;
}
...
{
vec4 l9_168=l9_160;
l9_168.x=l9_160.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_167=l9_168;
}
#else
{
...
#endif
vec3 l9_169=mix(l9_167.xyz,definedBlend(l9_167.xyz,l9_142.xyz).xyz,vec3(l9_141));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_171=vec4(mix(vec3(1.0),l9_142.xyz,vec3(l9_141)),l9_141);
}
#else
{
vec4 l9_172;
...
#endif
l9_172=vec4(l9_142.xyz*l9_173,l9_173);
}
#else
{
l9_172=l9_142;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_180-0.0039215689)),min(1.0,l9_180+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#endif
int l9_182=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_181).xy);
float l9_183=packValue(l9_182);
int l9_190=int(l9_179.w*255.0);
float l9_191=packValue(l9_190);
sc_writeFragData0Internal(vec4(packValue(l9_182),packValue(l9_182),packValue(l9_182),packValue(l9_182)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
if (l9_199==0)
{
l9_202=texture(sc_OITAlpha0,l9_194);
l9_201=texture(sc_OITDepthLow0,l9_194);
l9_200=texture(sc_OITDepthHigh0,l9_194);
}
else
{
l9_202=vec4(0.0);
...
if (l9_199==1)
{
l9_205=texture(sc_OITAlpha1,l9_194);
l9_204=texture(sc_OITDepthLow1,l9_194);
l9_203=texture(sc_OITDepthHigh1,l9_194);
}
else
{
l9_205=l9_202;
...
vec4 l9_220=texture(sc_OITFilteredDepthBoundsTexture,l9_194);
