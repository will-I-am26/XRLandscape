...
{
float l9_18=l9_16.x;
sc_SoftwareWrapEarly(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_19=l9_18;
float l9_20=l9_16.y;
sc_SoftwareWrapEarly(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_21=l9_20;
vec2 l9_22;
float l9_23;
...
{
l9_24=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
...
float l9_25=l9_19;
float l9_26=1.0;
sc_ClampUV(l9_25,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_24,l9_26);
float l9_27=l9_25;
float l9_28=l9_26;
bool l9_29;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_29=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_29=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_30=l9_21;
float l9_31=l9_28;
sc_ClampUV(l9_30,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_29,l9_31);
l9_23=l9_31;
...
#endif
vec2 l9_32=sc_TransformUV(l9_22,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_33=l9_32.x;
float l9_34=l9_23;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_34);
float l9_35=l9_32.y;
float l9_36=l9_34;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_36);
float l9_37=l9_36;
vec3 l9_38=sc_SamplingCoordsViewToGlobal(vec2(l9_33,l9_35),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_39=texture(additional_settings_btn_refl_texArrSC,l9_38,0.0);
vec4 l9_40;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_40=mix(additional_settings_btn_refl_texBorderColor,l9_39,vec4(l9_37));
}
#else
{
l9_40=l9_39;
...
{
float l9_41=l9_16.x;
sc_SoftwareWrapEarly(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_42=l9_41;
float l9_43=l9_16.y;
sc_SoftwareWrapEarly(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_44=l9_43;
vec2 l9_45;
float l9_46;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_47=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
...
float l9_48=l9_42;
float l9_49=1.0;
sc_ClampUV(l9_48,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_47,l9_49);
float l9_50=l9_48;
float l9_51=l9_49;
bool l9_52;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_52=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
...
float l9_53=l9_44;
float l9_54=l9_51;
sc_ClampUV(l9_53,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_52,l9_54);
l9_46=l9_54;
...
#endif
vec2 l9_55=sc_TransformUV(l9_45,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_56=l9_55.x;
float l9_57=l9_46;
sc_SoftwareWrapLate(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_57);
float l9_58=l9_55.y;
float l9_59=l9_57;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_59);
float l9_60=l9_59;
vec3 l9_61=sc_SamplingCoordsViewToGlobal(vec2(l9_56,l9_58),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_62=texture(additional_settings_btn_refl_tex,l9_61.xy,0.0);
vec4 l9_63;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_63=mix(additional_settings_btn_refl_texBorderColor,l9_62,vec4(l9_60));
}
#else
{
l9_63=l9_62;
...
#endif
vec4 l9_64=vec4(Port_Import_N062)*l9_17;
vec2 l9_65=l9_3*Port_Input1_N009;
float l9_66=clamp(length(l9_65+Port_Input2_N009),0.0,1.0);
vec4 l9_67;
if (l9_66<Port_Position1_N014)
{
l9_67=mix(Port_Value0_N014,Port_Value1_N014,vec4(clamp(l9_66/Port_Position1_N014,0.0,1.0)));
}
else
{
vec4 l9_68;
if (l9_66<Port_Position2_N014)
{
l9_68=mix(Port_Value1_N014,Port_Value2_N014,vec4(clamp((l9_66-Port_Position1_N014)/(Port_Position2_N014-Port_Position1_N014),0.0,1.0)));
}
else
{
l9_68=mix(Port_Value2_N014,Port_Value3_N014,vec4(clamp((l9_66-Port_Position2_N014)/(1.0-Port_Position2_N014),0.0,1.0)));
}
l9_67=l9_68;
}
vec4 l9_69=l9_64+l9_67;
vec2 l9_70=l9_4-Port_Center_N002;
vec2 l9_71=(l9_70*Port_Scale_N002)+Port_Center_N002;
vec4 l9_72;
#if (iconLayout==2)
{
float l9_73=l9_71.x;
...
vec4 l9_94=texture(iconArrSC,l9_93,0.0);
vec4 l9_95;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
...
vec4 l9_117=texture(icon,l9_116.xy,0.0);
vec4 l9_118;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
...
#if (iconLayout==2)
{
float l9_121=l9_71.x;
sc_SoftwareWrapEarly(l9_121,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_122=l9_121;
float l9_123=l9_71.y;
sc_SoftwareWrapEarly(l9_123,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_124=l9_123;
vec2 l9_125;
float l9_126;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_127=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_127=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_128=l9_122;
float l9_129=1.0;
sc_ClampUV(l9_128,iconUvMinMax.x,iconUvMinMax.z,l9_127,l9_129);
float l9_130=l9_128;
float l9_131=l9_129;
bool l9_132;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_132=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
...
float l9_133=l9_124;
float l9_134=l9_131;
sc_ClampUV(l9_133,iconUvMinMax.y,iconUvMinMax.w,l9_132,l9_134);
l9_126=l9_134;
...
#endif
vec2 l9_135=sc_TransformUV(l9_125,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_136=l9_135.x;
float l9_137=l9_126;
sc_SoftwareWrapLate(l9_136,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_137);
float l9_138=l9_135.y;
float l9_139=l9_137;
sc_SoftwareWrapLate(l9_138,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_139);
float l9_140=l9_139;
vec3 l9_141=sc_SamplingCoordsViewToGlobal(vec2(l9_136,l9_138),iconLayout,iconGetStereoViewIndex());
vec4 l9_142=texture(iconArrSC,l9_141,0.0);
vec4 l9_143;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_143=mix(iconBorderColor,l9_142,vec4(l9_140));
}
#else
{
l9_143=l9_142;
...
float l9_160=l9_149;
sc_SoftwareWrapLate(l9_159,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_160);
float l9_161=l9_158.y;
float l9_162=l9_160;
sc_SoftwareWrapLate(l9_161,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_162);
float l9_163=l9_162;
vec3 l9_164=sc_SamplingCoordsViewToGlobal(vec2(l9_159,l9_161),iconLayout,iconGetStereoViewIndex());
vec4 l9_165=texture(icon,l9_164.xy,0.0);
vec4 l9_166;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
...
{
l9_119=Port_Input2_N003;
}
vec4 l9_167=vec4(l9_119);
vec4 l9_168=mix(l9_69,l9_72,l9_167);
