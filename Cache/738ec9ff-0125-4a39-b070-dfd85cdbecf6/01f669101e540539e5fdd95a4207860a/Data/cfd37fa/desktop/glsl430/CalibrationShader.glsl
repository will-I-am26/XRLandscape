...
vec2 l9_6;
Node14_Rotate_Coords(l9_3,Port_Rotation_N014,Port_Center_N014,l9_6,l9_5);
vec2 l9_7=l9_6;
vec2 l9_8=l9_7+Port_Offset_N013;
float l9_9=l9_8.x;
float l9_10=l9_8.y;
float l9_11=(l9_9*l9_9)+(l9_10*l9_10);
float l9_12;
if (l9_11<=0.0)
{
l9_12=0.0;
...
float l9_13=Port_Input0_N008-CurrSize;
vec3 l9_14;
if ((float(l9_12<l9_13)*1.0)!=0.0)
{
l9_14=LoadingColor.xyz;
}
else
{
vec2 l9_15;
Node14_Rotate_Coords(l9_3,Port_Rotation_N014,Port_Center_N014,l9_15,l9_5);
vec2 l9_16=l9_15;
vec2 l9_17=l9_16+Port_Offset_N013;
float l9_18=l9_17.x;
float l9_19=l9_17.y;
...
bool l9_22=l9_21<l9_13;
bool l9_23=l9_21>(Port_Input0_N018+CurrSize);
bool l9_24=(float(l9_22)*1.0)!=0.0;
bool l9_25;
if (!l9_24)
{
l9_25=(float(l9_23)*1.0)!=0.0;
}
else
{
l9_25=l9_24;
}
float l9_26=float(l9_25);
bool l9_27=((1.0-l9_26)*1.0)!=0.0;
bool l9_28;
if (l9_27)
{
l9_28=(float(atan(l9_19,l9_18)<=((((Amount-Port_RangeMinA_N010)/(Port_RangeMaxA_N010-Port_RangeMinA_N010))*(Port_RangeMaxB_N010-Port_RangeMinB_N010))+Port_RangeMinB_N010))*1.0)!=0.0;
}
else
{
l9_28=l9_27;
...
vec3 l9_29;
if ((float(l9_28)*1.0)!=0.0)
{
l9_29=LoadingColor.xyz;
}
else
{
l9_29=StartColor.xyz;
}
l9_14=l9_29;
}
vec2 param_3;
Node14_Rotate_Coords(l9_3,Port_Rotation_N014,Port_Center_N014,param_3,l9_5);
vec2 l9_30=param_3;
vec2 l9_31=l9_30+Port_Offset_N013;
float l9_32=l9_31.x;
float l9_33=l9_31.y;
float l9_34=(l9_32*l9_32)+(l9_33*l9_33);
float l9_35;
if (l9_34<=0.0)
{
l9_35=0.0;
...
bool l9_36=l9_35<l9_13;
bool l9_37=l9_35>(Port_Input0_N018+CurrSize);
bool l9_38=(float(l9_36)*1.0)!=0.0;
bool l9_39;
if (!l9_38)
{
l9_39=(float(l9_37)*1.0)!=0.0;
}
else
{
l9_39=l9_38;
...
{
vec2 l9_42=l9_3-Port_Center_N026;
vec2 l9_43=(l9_42*vec2((((CurrSize-StartSize)/(Port_RangeMaxA_N029-StartSize))*(Port_RangeMaxB_N029-Port_RangeMinB_N029))+Port_RangeMinB_N029))+Port_Center_N026;
vec4 l9_44;
#if (IconTexLayout==2)
{
float l9_45=l9_43.x;
sc_SoftwareWrapEarly(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x);
float l9_46=l9_45;
float l9_47=l9_43.y;
sc_SoftwareWrapEarly(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y);
float l9_48=l9_47;
vec2 l9_49;
float l9_50;
...
{
l9_51=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x==3;
}
#else
{
l9_51=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_52=l9_46;
float l9_53=1.0;
sc_ClampUV(l9_52,IconTexUvMinMax.x,IconTexUvMinMax.z,l9_51,l9_53);
float l9_54=l9_52;
float l9_55=l9_53;
bool l9_56;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_56=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y==3;
}
#else
{
l9_56=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_57=l9_48;
float l9_58=l9_55;
sc_ClampUV(l9_57,IconTexUvMinMax.y,IconTexUvMinMax.w,l9_56,l9_58);
l9_50=l9_58;
...
#endif
vec2 l9_59=sc_TransformUV(l9_49,(int(SC_USE_UV_TRANSFORM_IconTex)!=0),IconTexTransform);
float l9_60=l9_59.x;
float l9_61=l9_50;
sc_SoftwareWrapLate(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x,(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0)),l9_61);
float l9_62=l9_59.y;
float l9_63=l9_61;
sc_SoftwareWrapLate(l9_62,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y,(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0)),l9_63);
float l9_64=l9_63;
vec3 l9_65=sc_SamplingCoordsViewToGlobal(vec2(l9_60,l9_62),IconTexLayout,IconTexGetStereoViewIndex());
vec4 l9_66=texture(IconTexArrSC,l9_65,0.0);
vec4 l9_67;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_67=mix(IconTexBorderColor,l9_66,vec4(l9_64));
}
#else
{
l9_67=l9_66;
...
float l9_83=l9_82.x;
float l9_84=l9_73;
sc_SoftwareWrapLate(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x,(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0)),l9_84);
float l9_85=l9_82.y;
float l9_86=l9_84;
sc_SoftwareWrapLate(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y,(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0)),l9_86);
float l9_87=l9_86;
...
{
vec2 l9_91=l9_3-Port_Center_N026;
vec2 l9_92=(l9_91*vec2((((CurrSize-StartSize)/(Port_RangeMaxA_N029-StartSize))*(Port_RangeMaxB_N029-Port_RangeMinB_N029))+Port_RangeMinB_N029))+Port_Center_N026;
vec4 l9_93;
#if (IconTexLayout==2)
{
float l9_94=l9_92.x;
...
float l9_110=l9_99;
sc_SoftwareWrapLate(l9_109,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x,(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0)),l9_110);
float l9_111=l9_108.y;
float l9_112=l9_110;
sc_SoftwareWrapLate(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y,(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0)),l9_112);
float l9_113=l9_112;
...
#else
{
float l9_117=l9_92.x;
sc_SoftwareWrapEarly(l9_117,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x);
float l9_118=l9_117;
float l9_119=l9_92.y;
sc_SoftwareWrapEarly(l9_119,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y);
float l9_120=l9_119;
vec2 l9_121;
float l9_122;
#if (SC_USE_UV_MIN_MAX_IconTex)
...
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_123=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x==3;
}
#else
{
l9_123=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_124=l9_118;
float l9_125=1.0;
sc_ClampUV(l9_124,IconTexUvMinMax.x,IconTexUvMinMax.z,l9_123,l9_125);
float l9_126=l9_124;
float l9_127=l9_125;
bool l9_128;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_128=ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y==3;
}
#else
{
l9_128=(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0);
}
#endif
float l9_129=l9_120;
float l9_130=l9_127;
sc_ClampUV(l9_129,IconTexUvMinMax.y,IconTexUvMinMax.w,l9_128,l9_130);
l9_122=l9_130;
...
#endif
vec2 l9_131=sc_TransformUV(l9_121,(int(SC_USE_UV_TRANSFORM_IconTex)!=0),IconTexTransform);
float l9_132=l9_131.x;
float l9_133=l9_122;
sc_SoftwareWrapLate(l9_132,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).x,(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0)),l9_133);
float l9_134=l9_131.y;
float l9_135=l9_133;
sc_SoftwareWrapLate(l9_134,ivec2(SC_SOFTWARE_WRAP_MODE_U_IconTex,SC_SOFTWARE_WRAP_MODE_V_IconTex).y,(int(SC_USE_CLAMP_TO_BORDER_IconTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_IconTex)!=0)),l9_135);
float l9_136=l9_135;
vec3 l9_137=sc_SamplingCoordsViewToGlobal(vec2(l9_132,l9_134),IconTexLayout,IconTexGetStereoViewIndex());
vec4 l9_138=texture(IconTex,l9_137.xy,0.0);
vec4 l9_139;
#if (SC_USE_CLAMP_TO_BORDER_IconTex)
{
l9_139=mix(IconTexBorderColor,l9_138,vec4(l9_136));
}
#else
{
l9_139=l9_138;
...
#endif
l9_41=(vec2(l9_93.w)*vec2((((CurrSize-Port_RangeMinA_N032)/(StartSize-Port_RangeMinA_N032))*(Port_RangeMaxB_N032-Port_RangeMinB_N032))+Port_RangeMinB_N032)).x;
}
float l9_140=(1.0-l9_40)+l9_41;
vec4 l9_141=vec4(l9_14.x,l9_14.y,l9_14.z,vec4(0.0).w);
l9_141.w=l9_140;
...
{
l9_165=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_163,sc_ScreenTextureLayout,l9_164),0.0);
}
#else
{
l9_165=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_163,sc_ScreenTextureLayout,l9_164).xy,0.0);
}
#endif
l9_159=l9_165;
}
...
{
vec4 l9_167=l9_159;
l9_167.x=l9_159.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_166=l9_167;
}
#else
{
...
#endif
vec3 l9_168=mix(l9_166.xyz,definedBlend(l9_166.xyz,l9_141.xyz).xyz,vec3(l9_140));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_170=vec4(mix(vec3(1.0),l9_141.xyz,vec3(l9_140)),l9_140);
}
#else
{
vec4 l9_171;
...
#endif
l9_171=vec4(l9_141.xyz*l9_172,l9_172);
}
#else
{
l9_171=l9_141;
