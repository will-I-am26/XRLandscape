...
float l9_32=float(sc_GetLocalInstanceID());
ssGlobals l9_33=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_30,l9_31,normalize((sc_ModelMatrixInverse*vec4(l9_31,0.0)).xyz),l9_32);
vec3 param_3;
Node19_If_else(0.0,vec3(0.0),vec3(0.0),param_3,l9_33);
vec3 l9_34=param_3;
...
float l9_38;
if ((float(float(sc_GetLocalInstanceID())>Port_Input1_N013)*1.0)!=0.0)
{
l9_38=abs(lineWeight)*Port_Input1_N017;
}
else
{
l9_38=abs(lineWeight);
}
vec3 l9_39=vec3(l9_38);
vec3 param_8;
Node19_If_else(0.0,vec3(0.0),vec3(0.0),param_8,l9_33);
vec3 l9_40=param_8;
vec3 l9_41;
vec3 l9_42;
vec3 l9_43;
...
l9_43=varTangent.xyz;
l9_42=l9_40;
l9_41=(sc_ModelMatrix*vec4(l9_30+(l9_37*l9_39),1.0)).xyz;
}
varPos=l9_41;
varNormal=normalize(l9_42);
vec3 l9_44=normalize(l9_43);
...
#if (sc_RenderingSpace==3)
{
l9_45=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_46;
#if (sc_RenderingSpace==2)
{
l9_46=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_47;
#if (sc_RenderingSpace==1)
{
l9_47=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
l9_47=l9_17;
...
#if (sc_RenderingSpace==4)
{
l9_49=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_50;
...
{
vec4 l9_56=l9_48;
l9_56.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_48.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_48.w;
l9_55=l9_56;
}
else
{
...
#if (sc_TAAEnabled)
{
vec2 l9_58=l9_54.xy+(sc_TAAJitterOffset*l9_54.w);
l9_57=vec4(l9_58.x,l9_58.y,l9_54.z,l9_54.w);
}
#else
{
l9_57=l9_54;
...
{
vec4 l9_60=l9_57;
l9_60.x=l9_57.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_59=l9_60;
}
#else
{
...
{
float l9_61=dot(l9_59,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_61);
}
#else
{
varClipDistance=l9_61;
}
#endif
}
#endif
gl_Position=l9_59;
Interpolator_gInstanceID=l9_32;
}
