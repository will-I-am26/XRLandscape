...
{
float l9_5=l9_3.x;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x);
float l9_6=l9_5;
float l9_7=l9_3.y;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y);
float l9_8=l9_7;
vec2 l9_9;
float l9_10;
...
{
l9_11=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x==3;
}
#else
{
l9_11=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_12=l9_6;
float l9_13=1.0;
sc_ClampUV(l9_12,glow_mapUvMinMax.x,glow_mapUvMinMax.z,l9_11,l9_13);
float l9_14=l9_12;
float l9_15=l9_13;
bool l9_16;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_17=l9_8;
float l9_18=l9_15;
sc_ClampUV(l9_17,glow_mapUvMinMax.y,glow_mapUvMinMax.w,l9_16,l9_18);
l9_10=l9_18;
...
#endif
vec2 l9_19=sc_TransformUV(l9_9,(int(SC_USE_UV_TRANSFORM_glow_map)!=0),glow_mapTransform);
float l9_20=l9_19.x;
float l9_21=l9_10;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x,(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glow_map)!=0)),l9_21);
float l9_22=l9_19.y;
float l9_23=l9_21;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y,(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glow_map)!=0)),l9_23);
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),glow_mapLayout,glow_mapGetStereoViewIndex());
vec4 l9_26=texture(glow_mapArrSC,l9_25,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_27=mix(glow_mapBorderColor,l9_26,vec4(l9_24));
}
#else
{
l9_27=l9_26;
...
{
float l9_28=l9_3.x;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x);
float l9_29=l9_28;
float l9_30=l9_3.y;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y);
float l9_31=l9_30;
vec2 l9_32;
float l9_33;
#if (SC_USE_UV_MIN_MAX_glow_map)
...
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_34=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x==3;
}
#else
{
l9_34=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_35=l9_29;
float l9_36=1.0;
sc_ClampUV(l9_35,glow_mapUvMinMax.x,glow_mapUvMinMax.z,l9_34,l9_36);
float l9_37=l9_35;
float l9_38=l9_36;
bool l9_39;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_39=ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y==3;
}
#else
{
l9_39=(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0);
}
#endif
float l9_40=l9_31;
float l9_41=l9_38;
sc_ClampUV(l9_40,glow_mapUvMinMax.y,glow_mapUvMinMax.w,l9_39,l9_41);
l9_33=l9_41;
...
#endif
vec2 l9_42=sc_TransformUV(l9_32,(int(SC_USE_UV_TRANSFORM_glow_map)!=0),glow_mapTransform);
float l9_43=l9_42.x;
float l9_44=l9_33;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).x,(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glow_map)!=0)),l9_44);
float l9_45=l9_42.y;
float l9_46=l9_44;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_glow_map,SC_SOFTWARE_WRAP_MODE_V_glow_map).y,(int(SC_USE_CLAMP_TO_BORDER_glow_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_glow_map)!=0)),l9_46);
float l9_47=l9_46;
vec3 l9_48=sc_SamplingCoordsViewToGlobal(vec2(l9_43,l9_45),glow_mapLayout,glow_mapGetStereoViewIndex());
vec4 l9_49=texture(glow_map,l9_48.xy,0.0);
vec4 l9_50;
#if (SC_USE_CLAMP_TO_BORDER_glow_map)
{
l9_50=mix(glow_mapBorderColor,l9_49,vec4(l9_47));
}
#else
{
l9_50=l9_49;
...
#endif
float l9_51=clamp(l9_4.x,0.0,1.0);
vec4 l9_52;
if (l9_51<Port_Position1_N005)
{
l9_52=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_51/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_53;
if (l9_51<Port_Position2_N005)
{
l9_53=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_51-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_53=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_51-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_52=l9_53;
}
...
if (l9_52.x<float(l9_52.x<Port_Input1_N003))
{
discard;
}
#if (sc_BlendMode_AlphaTest)
{
if (l9_52.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_52.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_63=clamp(l9_52.w*2.0,0.0,1.0);
}
#else
{
float l9_64;
...
{
l9_64=clamp(dot(l9_52.xyz,vec3(l9_52.w)),0.0,1.0);
}
#else
{
float l9_65;
...
{
l9_66=(1.0-dot(l9_52.xyz,vec3(0.33333001)))*l9_52.w;
}
#else
{
float l9_67;
...
{
l9_67=(1.0-clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0))*l9_52.w;
}
#else
{
float l9_68;
...
{
l9_68=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*l9_52.w;
}
#else
{
float l9_69;
#if (sc_BlendMode_Add)
{
l9_69=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_70;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_70=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*l9_52.w;
}
#else
{
float l9_71;
...
{
l9_71=dot(l9_52.xyz,vec3(0.33333001))*l9_52.w;
}
#else
{
float l9_72;
#if (sc_BlendMode_Min)
{
l9_72=1.0-clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_73;
#if (sc_BlendMode_Max)
{
l9_73=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_73=1.0;
...
#endif
l9_61=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_52.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_62);
}
#else
{
vec4 l9_74;
...
{
l9_82=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_80,sc_ScreenTextureLayout,l9_81),0.0);
}
#else
{
l9_82=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_80,sc_ScreenTextureLayout,l9_81).xy,0.0);
}
#endif
l9_76=l9_82;
}
...
#endif
vec3 l9_85=mix(l9_83.xyz,definedBlend(l9_83.xyz,l9_52.xyz).xyz,vec3(l9_52.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_87=vec4(mix(vec3(1.0),l9_52.xyz,vec3(l9_52.w)),l9_52.w);
}
#else
{
vec4 l9_88;
...
#endif
l9_88=vec4(l9_52.xyz*l9_89,l9_89);
}
#else
{
l9_88=l9_52;
