...
float l9_63=l9_62;
vec3 l9_64=sc_SamplingCoordsViewToGlobal(vec2(l9_59,l9_61),Tweak_N14Layout,Tweak_N14GetStereoViewIndex());
vec4 l9_65=texture(Tweak_N14ArrSC,l9_64,0.0);
vec4 l9_66;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N14)
{
...
float l9_82=l9_81.x;
float l9_83=l9_72;
sc_SoftwareWrapLate(l9_82,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N14,SC_SOFTWARE_WRAP_MODE_V_Tweak_N14).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N14)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N14)!=0)),l9_83);
float l9_84=l9_81.y;
float l9_85=l9_83;
sc_SoftwareWrapLate(l9_84,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N14,SC_SOFTWARE_WRAP_MODE_V_Tweak_N14).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N14)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N14)!=0)),l9_85);
float l9_86=l9_85;
...
#endif
vec3 l9_90=mix(l9_3.xyz,l9_35.xyz,vec3(1.0-l9_43.x));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_127-0.0039215689)),min(1.0,l9_127+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_129),packValue(l9_129),packValue(l9_129),packValue(l9_129)));
