...
vec2 l9_66=l9_4*Port_Input1_N009;
float l9_67=clamp(length(l9_66+Port_Input2_N009),0.0,1.0);
vec4 l9_68;
...
{
l9_69=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_67-Port_Position2_N007)/(1.0-Port_Position2_N007),0.0,1.0)));
}
l9_68=l9_69;
}
bool l9_70=PreviewEnabled==1;
bool l9_71;
if (l9_70)
{
l9_71=!l9_0;
...
float l9_75=clamp(l9_68.x,0.0,1.0);
float l9_76;
if (l9_75<Port_Position1_N018)
{
l9_76=mix(Port_Value0_N018,Port_Value1_N018,clamp(l9_75/Port_Position1_N018,0.0,1.0));
}
else
{
float l9_77;
if (l9_75<Port_Position2_N018)
{
l9_77=mix(Port_Value1_N018,Port_Value2_N018,clamp((l9_75-Port_Position1_N018)/(Port_Position2_N018-Port_Position1_N018),0.0,1.0));
}
else
{
float l9_78;
if (l9_75<Port_Position3_N018)
{
l9_78=mix(Port_Value2_N018,Port_Value3_N018,clamp((l9_75-Port_Position2_N018)/(Port_Position3_N018-Port_Position2_N018),0.0,1.0));
}
else
{
l9_78=mix(Port_Value3_N018,Port_Value4_N018,clamp((l9_75-Port_Position3_N018)/(1.0-Port_Position3_N018),0.0,1.0));
}
l9_77=l9_78;
}
l9_76=l9_77;
}
vec4 l9_79=vec4(l9_68.x,l9_68.y,l9_68.z,vec4(0.0).w);
l9_79.w=l9_76;
vec2 l9_80=l9_5-Port_Center_N002;
vec2 l9_81=(l9_80*Port_Scale_N002)+Port_Center_N002;
vec4 l9_82;
#if (iconLayout==2)
{
float l9_83=l9_81.x;
...
float l9_98=l9_97.x;
float l9_99=l9_88;
sc_SoftwareWrapLate(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_99);
float l9_100=l9_97.y;
float l9_101=l9_99;
sc_SoftwareWrapLate(l9_100,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_101);
float l9_102=l9_101;
vec3 l9_103=sc_SamplingCoordsViewToGlobal(vec2(l9_98,l9_100),iconLayout,iconGetStereoViewIndex());
vec4 l9_104=texture(iconArrSC,l9_103,0.0);
vec4 l9_105;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
...
float l9_122=l9_111;
sc_SoftwareWrapLate(l9_121,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_122);
float l9_123=l9_120.y;
float l9_124=l9_122;
sc_SoftwareWrapLate(l9_123,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_124);
float l9_125=l9_124;
...
#if (iconLayout==2)
{
float l9_131=l9_81.x;
sc_SoftwareWrapEarly(l9_131,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_132=l9_131;
float l9_133=l9_81.y;
sc_SoftwareWrapEarly(l9_133,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_134=l9_133;
vec2 l9_135;
float l9_136;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_137=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_138=l9_132;
float l9_139=1.0;
sc_ClampUV(l9_138,iconUvMinMax.x,iconUvMinMax.z,l9_137,l9_139);
float l9_140=l9_138;
float l9_141=l9_139;
bool l9_142;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_142=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
...
float l9_143=l9_134;
float l9_144=l9_141;
sc_ClampUV(l9_143,iconUvMinMax.y,iconUvMinMax.w,l9_142,l9_144);
l9_136=l9_144;
...
#endif
vec2 l9_145=sc_TransformUV(l9_135,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_146=l9_145.x;
float l9_147=l9_136;
sc_SoftwareWrapLate(l9_146,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_147);
float l9_148=l9_145.y;
float l9_149=l9_147;
sc_SoftwareWrapLate(l9_148,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_149);
float l9_150=l9_149;
vec3 l9_151=sc_SamplingCoordsViewToGlobal(vec2(l9_146,l9_148),iconLayout,iconGetStereoViewIndex());
vec4 l9_152=texture(iconArrSC,l9_151,0.0);
vec4 l9_153;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_153=mix(iconBorderColor,l9_152,vec4(l9_150));
}
#else
{
l9_153=l9_152;
...
#else
{
float l9_154=l9_81.x;
sc_SoftwareWrapEarly(l9_154,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_155=l9_154;
float l9_156=l9_81.y;
sc_SoftwareWrapEarly(l9_156,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_157=l9_156;
vec2 l9_158;
float l9_159;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_160=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_160=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_161=l9_155;
float l9_162=1.0;
sc_ClampUV(l9_161,iconUvMinMax.x,iconUvMinMax.z,l9_160,l9_162);
float l9_163=l9_161;
float l9_164=l9_162;
bool l9_165;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_165=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_165=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_166=l9_157;
float l9_167=l9_164;
sc_ClampUV(l9_166,iconUvMinMax.y,iconUvMinMax.w,l9_165,l9_167);
l9_159=l9_167;
...
#endif
vec2 l9_168=sc_TransformUV(l9_158,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_169=l9_168.x;
float l9_170=l9_159;
sc_SoftwareWrapLate(l9_169,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_170);
float l9_171=l9_168.y;
float l9_172=l9_170;
sc_SoftwareWrapLate(l9_171,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_172);
float l9_173=l9_172;
vec3 l9_174=sc_SamplingCoordsViewToGlobal(vec2(l9_169,l9_171),iconLayout,iconGetStereoViewIndex());
vec4 l9_175=texture(icon,l9_174.xy,0.0);
vec4 l9_176;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_176=mix(iconBorderColor,l9_175,vec4(l9_173));
}
#else
{
l9_176=l9_175;
...
{
l9_129=Port_Input2_N003;
}
vec4 l9_177=vec4(l9_129);
vec4 l9_178=mix(l9_65+l9_79,l9_82,l9_177);
...
#endif
sc_writeFragData0(max(l9_180,vec4(0.0)));
return;
}
vec4 l9_182;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_217-0.0039215689)),min(1.0,l9_217+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_219),packValue(l9_219),packValue(l9_219),packValue(l9_219)));
