...
vec4 l9_167;
if (l9_166<Port_Position1_N030)
{
l9_167=mix(Port_Value0_N030,Port_Value1_N030,vec4(clamp(l9_166/Port_Position1_N030,0.0,1.0)));
}
else
{
vec4 l9_168;
if (l9_166<Port_Position2_N030)
{
l9_168=mix(Port_Value1_N030,Port_Value2_N030,vec4(clamp((l9_166-Port_Position1_N030)/(Port_Position2_N030-Port_Position1_N030),0.0,1.0)));
}
else
{
vec4 l9_169;
if (l9_166<Port_Position3_N030)
{
l9_169=mix(Port_Value2_N030,Port_Value3_N030,vec4(clamp((l9_166-Port_Position2_N030)/(Port_Position3_N030-Port_Position2_N030),0.0,1.0)));
}
else
{
vec4 l9_170;
if (l9_166<Port_Position4_N030)
{
l9_170=mix(Port_Value3_N030,Port_Value4_N030,vec4(clamp((l9_166-Port_Position3_N030)/(Port_Position4_N030-Port_Position3_N030),0.0,1.0)));
}
else
{
l9_170=mix(Port_Value4_N030,Port_Value5_N030,vec4(clamp((l9_166-Port_Position4_N030)/(1.0-Port_Position4_N030),0.0,1.0)));
}
l9_169=l9_170;
}
l9_168=l9_169;
...
vec3 l9_171=-l9_4;
vec4 l9_172=mix(l9_167,Port_Input1_N000,vec4(max(pow(1.0-abs(dot(l9_171,l9_11*Port_Normal_N001)),Port_Exponent_N001),0.0)*Port_Intensity_N001));
vec4 l9_173=l9_112+l9_172;
float l9_174=l9_173.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_174<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_174<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_175,vec4(0.0)));
return;
}
vec4 l9_177;
...
{
l9_179=clamp(l9_174*2.0,0.0,1.0);
}
#else
{
float l9_180;
...
{
l9_180=clamp(dot(l9_173.xyz,vec3(l9_174)),0.0,1.0);
}
#else
{
float l9_181;
...
{
l9_182=(1.0-dot(l9_173.xyz,vec3(0.33333001)))*l9_174;
}
#else
{
float l9_183;
...
{
l9_183=(1.0-clamp(dot(l9_173.xyz,vec3(1.0)),0.0,1.0))*l9_174;
}
#else
{
float l9_184;
...
{
l9_184=clamp(dot(l9_173.xyz,vec3(1.0)),0.0,1.0)*l9_174;
}
#else
{
float l9_185;
#if (sc_BlendMode_Add)
{
l9_185=clamp(dot(l9_173.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_186;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_186=clamp(dot(l9_173.xyz,vec3(1.0)),0.0,1.0)*l9_174;
}
#else
{
float l9_187;
...
{
l9_187=dot(l9_173.xyz,vec3(0.33333001))*l9_174;
}
#else
{
float l9_188;
#if (sc_BlendMode_Min)
{
l9_188=1.0-clamp(dot(l9_173.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_189;
#if (sc_BlendMode_Max)
{
l9_189=clamp(dot(l9_173.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_189=1.0;
...
#endif
l9_177=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_173.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_178);
}
#else
{
vec4 l9_190;
...
#if (sc_FramebufferFetch)
{
vec4 l9_193=sc_readFragData0_Platform();
vec4 l9_194;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_195=l9_193;
l9_195.x=l9_193.x+_sc_framebufferFetchMarker;
l9_194=l9_195;
}
#else
{
...
{
l9_197=1-sc_GetStereoViewIndex();
}
#else
{
l9_197=sc_GetStereoViewIndex();
}
#endif
vec4 l9_198;
#if (sc_ScreenTextureLayout==2)
{
l9_198=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_196,sc_ScreenTextureLayout,l9_197),0.0);
}
#else
{
l9_198=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_196,sc_ScreenTextureLayout,l9_197).xy,0.0);
}
#endif
l9_192=l9_198;
}
...
{
vec4 l9_200=l9_192;
l9_200.x=l9_192.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_199=l9_200;
}
#else
{
...
#endif
vec3 l9_201=mix(l9_199.xyz,definedBlend(l9_199.xyz,l9_173.xyz).xyz,vec3(l9_174));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_203=vec4(mix(vec3(1.0),l9_173.xyz,vec3(l9_174)),l9_174);
}
#else
{
vec4 l9_204;
...
#endif
l9_204=vec4(l9_173.xyz*l9_205,l9_205);
}
#else
{
l9_204=l9_173;
...
{
l9_208=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_208=vec4(0.0);
...
vec4 l9_210=outputMotionVectorsIfNeeded(varPos,max(l9_209,vec4(0.0)));
vec4 l9_211=clamp(l9_210,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_212=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_212-0.0039215689)),min(1.0,l9_212+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_214=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_213).xy);
float l9_215=packValue(l9_214);
int l9_222=int(l9_211.w*255.0);
float l9_223=packValue(l9_222);
sc_writeFragData0(vec4(packValue(l9_214),packValue(l9_214),packValue(l9_214),packValue(l9_214)));
sc_writeFragData1(vec4(l9_215,packValue(l9_214),packValue(l9_214),packValue(l9_214)));
sc_writeFragData2(vec4(l9_223,packValue(l9_222),packValue(l9_222),packValue(l9_222)));
...
if (l9_231==0)
{
l9_234=texture(sc_OITAlpha0,l9_226);
l9_233=texture(sc_OITDepthLow0,l9_226);
l9_232=texture(sc_OITDepthHigh0,l9_226);
}
else
{
l9_234=vec4(0.0);
...
if (l9_231==1)
{
l9_237=texture(sc_OITAlpha1,l9_226);
l9_236=texture(sc_OITDepthLow1,l9_226);
l9_235=texture(sc_OITDepthHigh1,l9_226);
}
else
{
l9_237=l9_234;
...
{
int l9_238[8]=l9_227;
unpackValues(l9_235.w,l9_231,l9_238);
unpackValues(l9_235.z,l9_231,l9_238);
unpackValues(l9_235.y,l9_231,l9_238);
unpackValues(l9_235.x,l9_231,l9_238);
unpackValues(l9_236.w,l9_231,l9_238);
unpackValues(l9_236.z,l9_231,l9_238);
unpackValues(l9_236.y,l9_231,l9_238);
unpackValues(l9_236.x,l9_231,l9_238);
int l9_247[8]=l9_228;
unpackValues(l9_237.w,l9_231,l9_247);
unpackValues(l9_237.z,l9_231,l9_247);
unpackValues(l9_237.y,l9_231,l9_247);
unpackValues(l9_237.x,l9_231,l9_247);
}
l9_231++;
continue;
}
...
vec4 l9_252=texture(sc_OITFilteredDepthBoundsTexture,l9_226);
vec2 l9_253=l9_252.xy;
int l9_254;
#if (sc_SkinBonesCount>0)
{
l9_254=encodeDepth(((1.0-l9_252.x)*1000.0)+getDepthOrderingEpsilon(),l9_253);
}
#else
{
l9_254=0;
...
#endif
int l9_255=encodeDepth(viewSpaceDepth(),l9_253);
vec4 l9_256;
l9_256=l9_211*l9_211.w;
vec4 l9_257;
int l9_258=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_258<8)
{
int l9_259=l9_227[l9_258];
int l9_260=l9_255-l9_254;
bool l9_261=l9_259<l9_260;
bool l9_262;
if (l9_261)
{
l9_262=l9_227[l9_258]>0;
}
else
{
l9_262=l9_261;
...
if (l9_262)
{
vec3 l9_263=l9_256.xyz*(1.0-(float(l9_228[l9_258])/255.0));
l9_257=vec4(l9_263.x,l9_263.y,l9_263.z,l9_256.w);
}
else
{
l9_257=l9_256;
