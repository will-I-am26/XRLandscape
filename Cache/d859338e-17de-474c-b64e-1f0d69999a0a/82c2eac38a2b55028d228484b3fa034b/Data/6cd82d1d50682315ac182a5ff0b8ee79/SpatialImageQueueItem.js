...
exports.SpatialImageQueueItem = exports.SpatializeResult = void 0;
...
var SpatializeResult;
(function (SpatializeResult) {
    SpatializeResult[SpatializeResult["Awaiting"] = 0] = "Awaiting";
    SpatializeResult[SpatializeResult["Attempting"] = 1] = "Attempting";
    SpatializeResult[SpatializeResult["Completed"] = 2] = "Completed";
    SpatializeResult[SpatializeResult["Retry"] = 3] = "Retry";
    SpatializeResult[SpatializeResult["Rejected"] = 4] = "Rejected";
})(SpatializeResult || (exports.SpatializeResult = SpatializeResult = {}));
/**
 ...
 * part of a queue.
 */
class SpatialImageQueueItem {
    constructor(imageTexture, remoteServiceModule, spatialImageMaterial, objectParent, callback, requestId) {
        this._active = false;
        this.spatializeResult = SpatializeResult.Awaiting;
     ...
     */
    async encodeAndCreateRequest(image) {
     ...
     */
    loadAsset(assetUrl) {
        return new Promise((resolve, reject) => remoteMediaModule.loadResourceAsGltfAsset(
        // Use makeResourceFromUrl to ensure the userdata restrictions can be enforced for 3P lenses
        this.remoteServiceModule.makeResourceFromUrl(assetUrl), (asset) => {
            try {
                const instantiatedImage = asset.tryInstantiate(this.objectParent, this.spatialImageMaterial);
    ...
    encodeTexture(texture) {
        return new Promise((resolve, reject) => {
            try {
                Base64.encodeTextureAsync(texture, (string) => {
                    resolve(string);
                }, () => {
...
exports.SpatialImageQueueItem = SpatialImageQueueItem;
//# sourceMappingURL=SpatialImageQueueItem.js.map