...
float l9_69=l9_68;
vec3 l9_70=sc_SamplingCoordsViewToGlobal(vec2(l9_65,l9_67),matcapTextureLayout,matcapTextureGetStereoViewIndex());
vec4 l9_71=texture(matcapTextureArrSC,l9_70,0.0);
vec4 l9_72;
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
...
{
float l9_73=l9_48.x;
sc_SoftwareWrapEarly(l9_73,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x);
float l9_74=l9_73;
float l9_75=l9_48.y;
sc_SoftwareWrapEarly(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y);
float l9_76=l9_75;
vec2 l9_77;
float l9_78;
#if (SC_USE_UV_MIN_MAX_matcapTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
l9_79=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x==3;
}
#else
{
l9_79=(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0);
}
#endif
float l9_80=l9_74;
float l9_81=1.0;
sc_ClampUV(l9_80,matcapTextureUvMinMax.x,matcapTextureUvMinMax.z,l9_79,l9_81);
float l9_82=l9_80;
float l9_83=l9_81;
bool l9_84;
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
l9_84=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y==3;
}
#else
{
l9_84=(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0);
}
#endif
float l9_85=l9_76;
float l9_86=l9_83;
sc_ClampUV(l9_85,matcapTextureUvMinMax.y,matcapTextureUvMinMax.w,l9_84,l9_86);
l9_78=l9_86;
l9_77=vec2(l9_82,l9_85);
}
#else
...
#endif
vec2 l9_87=sc_TransformUV(l9_77,(int(SC_USE_UV_TRANSFORM_matcapTexture)!=0),matcapTextureTransform);
float l9_88=l9_87.x;
float l9_89=l9_78;
sc_SoftwareWrapLate(l9_88,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x,(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_matcapTexture)!=0)),l9_89);
float l9_90=l9_87.y;
float l9_91=l9_89;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y,(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_matcapTexture)!=0)),l9_91);
float l9_92=l9_91;
vec3 l9_93=sc_SamplingCoordsViewToGlobal(vec2(l9_88,l9_90),matcapTextureLayout,matcapTextureGetStereoViewIndex());
vec4 l9_94=texture(matcapTexture,l9_93.xy,0.0);
vec4 l9_95;
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
l9_95=mix(matcapTextureBorderColor,l9_94,vec4(l9_92));
}
#else
{
l9_95=l9_94;
...
{
l9_96=pow(l9_44,Port_Input1_N087);
}
vec4 l9_97=vec4(l9_96);
vec4 l9_98=max(l9_45,mix(Port_Input0_N024,Port_Input1_N024,l9_97));
float l9_99=borderAlpha*l9_44;
float l9_100;
if (l9_32<=0.0)
{
l9_100=0.0;
...
{
l9_100=pow(l9_32,(((borderAlpha-Port_RangeMinA_N129)/(Port_RangeMaxA_N129-Port_RangeMinA_N129))*(Port_RangeMaxB_N129-Port_RangeMinB_N129))+Port_RangeMinB_N129);
}
float l9_101=(backingAlpha*Port_Input1_N052)*l9_100;
float l9_102=(isHovered*smoothstep(Port_Input0_N166*l9_2,Port_Input1_N165,l9_16))*smoothstep(Port_Input0_N157,Port_Input1_N157,(clamp(smoothstep((-Port_handleWidth_N104)*0.5,0.0,l9_33),0.0,1.0)-clamp(smoothstep(0.0,Port_handleWidth_N104*0.5,l9_33),0.0,1.0))*((((0.0+((l9_36*l9_39)*scaleHandles.x))+((l9_41*l9_39)*scaleHandles.y))+((l9_41*l9_43)*scaleHandles.z))+((l9_36*l9_43)*scaleHandles.w)));
vec4 l9_103=vec4(Port_Value1_N156.x,Port_Value1_N156.y,Port_Value1_N156.z,vec4(0.0).w);
l9_103.w=l9_102;
vec4 l9_104=mix(vec4((Port_Value_N151.xyz*l9_101)+((l9_98*vec4(Port_Input1_N149)).xyz*l9_99),max(l9_101,l9_99)),l9_103,vec4(l9_102));
vec3 l9_105=mix(Port_Input0_N055,mix(Port_Value_N073,Port_Value_N054,l9_21),vec3(l9_25))+l9_104.xyz;
float l9_106=(l9_104.w*opacity)*max(Port_Input0_N107-cutOutCenter,smoothstep(Port_Input0_N106,Port_Input0_N091/l9_1,length(max(abs(l9_12)-vec2(Port_Input1_N085),Port_Input1_N102)/l9_15)));
vec4 l9_107=vec4(l9_105.x,l9_105.y,l9_105.z,vec4(0.0).w);
l9_107.w=l9_106;
if ((step(l9_106,Port_Input1_N093)*1.0)!=0.0)
{
discard;
}
...
{
l9_110=clamp(l9_106*2.0,0.0,1.0);
}
#else
{
float l9_111;
...
{
l9_111=clamp(dot(l9_107.xyz,vec3(l9_106)),0.0,1.0);
}
#else
{
float l9_112;
...
{
l9_113=(1.0-dot(l9_107.xyz,vec3(0.33333001)))*l9_106;
}
#else
{
float l9_114;
...
{
l9_114=(1.0-clamp(dot(l9_107.xyz,vec3(1.0)),0.0,1.0))*l9_106;
}
#else
{
float l9_115;
...
{
l9_115=clamp(dot(l9_107.xyz,vec3(1.0)),0.0,1.0)*l9_106;
}
#else
{
float l9_116;
#if (sc_BlendMode_Add)
{
l9_116=clamp(dot(l9_107.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_117;
...
{
l9_118=dot(l9_107.xyz,vec3(0.33333001))*l9_106;
}
#else
{
float l9_119;
#if (sc_BlendMode_Min)
{
l9_119=1.0-clamp(dot(l9_107.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_120;
#if (sc_BlendMode_Max)
{
l9_120=clamp(dot(l9_107.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_120=1.0;
...
#endif
l9_108=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_107.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_109);
}
#else
{
vec4 l9_121;
...
#endif
vec3 l9_132=mix(l9_130.xyz,definedBlend(l9_130.xyz,l9_107.xyz).xyz,vec3(l9_106));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_134=vec4(mix(vec3(1.0),l9_107.xyz,vec3(l9_106)),l9_106);
}
#else
{
vec4 l9_135;
...
#endif
l9_135=vec4(l9_107.xyz*l9_136,l9_136);
}
#else
{
l9_135=l9_107;
