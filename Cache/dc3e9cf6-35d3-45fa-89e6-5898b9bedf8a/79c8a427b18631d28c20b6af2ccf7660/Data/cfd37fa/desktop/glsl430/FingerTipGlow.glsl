...
{
float l9_3=l9_0.x;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x);
float l9_4=l9_3;
float l9_5=l9_0.y;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y);
float l9_6=l9_5;
vec2 l9_7;
float l9_8;
...
{
l9_9=ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x==3;
}
#else
{
l9_9=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0);
}
#endif
float l9_10=l9_4;
float l9_11=1.0;
sc_ClampUV(l9_10,mainTexUvMinMax.x,mainTexUvMinMax.z,l9_9,l9_11);
float l9_12=l9_10;
float l9_13=l9_11;
bool l9_14;
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y==3;
}
#else
{
l9_14=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0);
}
#endif
float l9_15=l9_6;
float l9_16=l9_13;
sc_ClampUV(l9_15,mainTexUvMinMax.y,mainTexUvMinMax.w,l9_14,l9_16);
l9_8=l9_16;
...
#endif
vec2 l9_17=sc_TransformUV(l9_7,(int(SC_USE_UV_TRANSFORM_mainTex)!=0),mainTexTransform);
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x,(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_mainTex)!=0)),l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y,(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_mainTex)!=0)),l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),mainTexLayout,mainTexGetStereoViewIndex());
vec4 l9_24=texture(mainTexArrSC,l9_23,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_25=mix(mainTexBorderColor,l9_24,vec4(l9_22));
}
#else
{
l9_25=l9_24;
...
{
float l9_26=l9_0.x;
sc_SoftwareWrapEarly(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x);
float l9_27=l9_26;
float l9_28=l9_0.y;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y);
float l9_29=l9_28;
vec2 l9_30;
float l9_31;
#if (SC_USE_UV_MIN_MAX_mainTex)
...
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_32=ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x==3;
}
#else
{
l9_32=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0);
}
#endif
float l9_33=l9_27;
float l9_34=1.0;
sc_ClampUV(l9_33,mainTexUvMinMax.x,mainTexUvMinMax.z,l9_32,l9_34);
float l9_35=l9_33;
float l9_36=l9_34;
bool l9_37;
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_37=ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y==3;
}
#else
{
l9_37=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0);
}
#endif
float l9_38=l9_29;
float l9_39=l9_36;
sc_ClampUV(l9_38,mainTexUvMinMax.y,mainTexUvMinMax.w,l9_37,l9_39);
l9_31=l9_39;
...
#endif
vec2 l9_40=sc_TransformUV(l9_30,(int(SC_USE_UV_TRANSFORM_mainTex)!=0),mainTexTransform);
float l9_41=l9_40.x;
float l9_42=l9_31;
sc_SoftwareWrapLate(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x,(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_mainTex)!=0)),l9_42);
float l9_43=l9_40.y;
float l9_44=l9_42;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y,(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_mainTex)!=0)),l9_44);
float l9_45=l9_44;
vec3 l9_46=sc_SamplingCoordsViewToGlobal(vec2(l9_41,l9_43),mainTexLayout,mainTexGetStereoViewIndex());
vec4 l9_47=texture(mainTex,l9_46.xy,0.0);
vec4 l9_48;
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_48=mix(mainTexBorderColor,l9_47,vec4(l9_45));
}
#else
{
l9_48=l9_47;
...
#endif
vec3 l9_49=vec3(l9_2.xyz)*vec3(glowColor.xyz);
float l9_50=((glowColor.w*l9_2.w)*brightness)*max(pinchBrightness,pokeBrightness);
...
{
l9_57=clamp(dot(l9_51.xyz,vec3(l9_50)),0.0,1.0);
}
#else
{
float l9_58;
...
{
l9_59=(1.0-dot(l9_51.xyz,vec3(0.33333001)))*l9_50;
}
#else
{
float l9_60;
...
{
l9_60=(1.0-clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0))*l9_50;
}
#else
{
float l9_61;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_63=clamp(dot(l9_51.xyz,vec3(1.0)),0.0,1.0)*l9_50;
}
#else
{
float l9_64;
...
{
l9_64=dot(l9_51.xyz,vec3(0.33333001))*l9_50;
}
#else
{
float l9_65;
...
#endif
vec3 l9_78=mix(l9_76.xyz,definedBlend(l9_76.xyz,l9_51.xyz).xyz,vec3(l9_50));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_80=vec4(mix(vec3(1.0),l9_51.xyz,vec3(l9_50)),l9_50);
}
#else
{
vec4 l9_81;
...
#endif
l9_81=vec4(l9_51.xyz*l9_82,l9_82);
}
#else
{
l9_81=l9_51;
