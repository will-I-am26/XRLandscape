...
#endif
float l9_67=(mix(baseColor,SecondGradient,vec4(varPackedTex.y))*l9_11).w*l9_12;
...
#endif
float l9_80=(mix(baseColor,SecondGradient,vec4(l9_8.y))*l9_24).w*l9_25;
...
vec4 l9_204=l9_203*vec4(colorMultiplier+1.0);
float l9_205=l9_203.w;
vec4 l9_206=vec4(l9_204.x,l9_204.y,l9_204.z,vec4(0.0).w);
l9_206.w=l9_205;
if (isProxyMode)
{
vec4 l9_207;
...
#endif
sc_writeFragData0(max(l9_207,vec4(0.0)));
return;
}
vec4 l9_209;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_211=clamp(l9_205*2.0,0.0,1.0);
}
#else
{
float l9_212;
...
{
l9_212=clamp(dot(l9_206.xyz,vec3(l9_205)),0.0,1.0);
}
#else
{
float l9_213;
...
#if (sc_BlendMode_Multiply)
{
l9_214=(1.0-dot(l9_206.xyz,vec3(0.33333001)))*l9_205;
}
#else
{
float l9_215;
...
{
l9_215=(1.0-clamp(dot(l9_206.xyz,vec3(1.0)),0.0,1.0))*l9_205;
}
#else
{
float l9_216;
#if (sc_BlendMode_ColoredGlass)
{
l9_216=clamp(dot(l9_206.xyz,vec3(1.0)),0.0,1.0)*l9_205;
}
#else
{
float l9_217;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_218=clamp(dot(l9_206.xyz,vec3(1.0)),0.0,1.0)*l9_205;
}
#else
{
float l9_219;
...
{
l9_219=dot(l9_206.xyz,vec3(0.33333001))*l9_205;
}
#else
{
float l9_220;
...
vec3 l9_225=mix(l9_224,definedBlend(l9_224,l9_206.xyz).xyz,vec3(l9_205));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_227=vec4(mix(vec3(1.0),l9_206.xyz,vec3(l9_205)),l9_205);
}
#else
{
vec4 l9_228;
...
#endif
l9_228=vec4(l9_206.xyz*l9_229,l9_229);
}
#else
{
l9_228=l9_206;
