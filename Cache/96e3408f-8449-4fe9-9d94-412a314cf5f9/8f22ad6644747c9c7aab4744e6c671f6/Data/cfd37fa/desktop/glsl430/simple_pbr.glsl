...
#endif
float l9_54=clamp(l9_52.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_55=max(l9_52.xyz,vec3(0.0));
vec4 l9_56;
#if (sc_ProjectiveShadowsCaster)
{
...
#else
{
l9_56=ngsCalculateLighting(l9_55,l9_54,l9_53,l9_2,l9_3,Port_Emissive_N006,clamp(metallic,0.0,1.0),clamp(roughness,0.0,1.0),Port_AO_N006,Port_SpecularAO_N006);
}
#endif
...
#endif
sc_writeFragData0(max(l9_58,vec4(0.0)));
return;
}
vec4 l9_60;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_62=clamp(l9_57.w*2.0,0.0,1.0);
}
#else
{
float l9_63;
...
{
l9_63=clamp(dot(l9_57.xyz,vec3(l9_57.w)),0.0,1.0);
}
#else
{
float l9_64;
...
#if (sc_BlendMode_Multiply)
{
l9_65=(1.0-dot(l9_57.xyz,vec3(0.33333001)))*l9_57.w;
}
#else
{
float l9_66;
...
{
l9_66=(1.0-clamp(dot(l9_57.xyz,vec3(1.0)),0.0,1.0))*l9_57.w;
}
#else
{
float l9_67;
#if (sc_BlendMode_ColoredGlass)
{
l9_67=clamp(dot(l9_57.xyz,vec3(1.0)),0.0,1.0)*l9_57.w;
}
#else
{
float l9_68;
#if (sc_BlendMode_Add)
{
l9_68=clamp(dot(l9_57.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_69;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_69=clamp(dot(l9_57.xyz,vec3(1.0)),0.0,1.0)*l9_57.w;
}
#else
{
float l9_70;
...
{
l9_70=dot(l9_57.xyz,vec3(0.33333001))*l9_57.w;
}
#else
{
float l9_71;
#if (sc_BlendMode_Min)
{
l9_71=1.0-clamp(dot(l9_57.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_72;
#if (sc_BlendMode_Max)
{
l9_72=clamp(dot(l9_57.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_72=1.0;
...
#endif
l9_60=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_57.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_61);
}
#else
{
vec4 l9_73;
...
{
vec3 l9_75=sc_GetFramebufferColor().xyz;
vec3 l9_76=mix(l9_75,definedBlend(l9_75,l9_57.xyz).xyz,vec3(l9_57.w));
...
{
float l9_79=l9_57.w;
l9_78=vec4(mix(vec3(1.0),l9_57.xyz,vec3(l9_79)),l9_79);
}
#else
{
vec4 l9_80;
...
#endif
l9_80=vec4(l9_57.xyz*l9_82,l9_82);
}
#else
{
l9_80=l9_57;
