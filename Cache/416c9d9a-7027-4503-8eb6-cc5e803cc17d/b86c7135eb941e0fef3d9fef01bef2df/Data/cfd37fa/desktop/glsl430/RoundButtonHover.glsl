...
vec4 l9_67;
if (l9_66<Port_Position1_N007)
{
l9_67=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_66/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_68;
if (l9_66<Port_Position2_N007)
{
l9_68=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_66-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
vec4 l9_69;
if (l9_66<Port_Position3_N007)
{
l9_69=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_66-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_69=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_66-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_68=l9_69;
}
l9_67=l9_68;
...
vec3 l9_70=-l9_4;
vec4 l9_71=mix(l9_67,Port_Input1_N035,vec4(max(pow(1.0-abs(dot(l9_70,l9_11*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_72=l9_71.w;
vec3 l9_73=(l9_64.xyz+Port_Input1_N002)+l9_71.xyz;
...
#endif
sc_writeFragData0(max(l9_75,vec4(0.0)));
return;
}
vec4 l9_77;
