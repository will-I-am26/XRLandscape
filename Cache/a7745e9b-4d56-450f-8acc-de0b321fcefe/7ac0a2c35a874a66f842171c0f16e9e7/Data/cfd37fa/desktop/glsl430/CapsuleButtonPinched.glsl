...
vec4 l9_167;
if (l9_166<Port_Position1_N067)
{
l9_167=mix(Port_Value0_N067,Port_Value1_N067,vec4(clamp(l9_166/Port_Position1_N067,0.0,1.0)));
}
else
{
vec4 l9_168;
if (l9_166<Port_Position2_N067)
{
l9_168=mix(Port_Value1_N067,Port_Value2_N067,vec4(clamp((l9_166-Port_Position1_N067)/(Port_Position2_N067-Port_Position1_N067),0.0,1.0)));
}
else
{
vec4 l9_169;
if (l9_166<Port_Position3_N067)
{
l9_169=mix(Port_Value2_N067,Port_Value3_N067,vec4(clamp((l9_166-Port_Position2_N067)/(Port_Position3_N067-Port_Position2_N067),0.0,1.0)));
}
else
{
l9_169=mix(Port_Value3_N067,Port_Value4_N067,vec4(clamp((l9_166-Port_Position3_N067)/(1.0-Port_Position3_N067),0.0,1.0)));
}
l9_168=l9_169;
}
l9_167=l9_168;
...
vec3 l9_170=-l9_4;
vec4 l9_171=mix(l9_167,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(l9_170,l9_11*Port_Normal_N023)),Port_Exponent_N023),0.0)*Port_Intensity_N023));
vec4 l9_172=l9_112+l9_171;
float l9_173=l9_172.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_173<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_173<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_174,vec4(0.0)));
return;
}
vec4 l9_176;
...
{
l9_178=clamp(l9_173*2.0,0.0,1.0);
}
#else
{
float l9_179;
...
{
l9_179=clamp(dot(l9_172.xyz,vec3(l9_173)),0.0,1.0);
}
#else
{
float l9_180;
...
{
l9_181=(1.0-dot(l9_172.xyz,vec3(0.33333001)))*l9_173;
}
#else
{
float l9_182;
...
{
l9_182=(1.0-clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0))*l9_173;
}
#else
{
float l9_183;
...
{
l9_183=clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0)*l9_173;
}
#else
{
float l9_184;
#if (sc_BlendMode_Add)
{
l9_184=clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_185;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_185=clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0)*l9_173;
}
#else
{
float l9_186;
...
{
l9_186=dot(l9_172.xyz,vec3(0.33333001))*l9_173;
}
#else
{
float l9_187;
#if (sc_BlendMode_Min)
{
l9_187=1.0-clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_188;
#if (sc_BlendMode_Max)
{
l9_188=clamp(dot(l9_172.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_188=1.0;
...
#endif
l9_176=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_172.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_177);
}
#else
{
vec4 l9_189;
...
#if (sc_FramebufferFetch)
{
vec4 l9_192=sc_readFragData0_Platform();
vec4 l9_193;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_194=l9_192;
l9_194.x=l9_192.x+_sc_framebufferFetchMarker;
l9_193=l9_194;
}
#else
{
...
{
l9_196=1-sc_GetStereoViewIndex();
}
#else
{
l9_196=sc_GetStereoViewIndex();
}
#endif
vec4 l9_197;
#if (sc_ScreenTextureLayout==2)
{
l9_197=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_195,sc_ScreenTextureLayout,l9_196),0.0);
}
#else
{
l9_197=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_195,sc_ScreenTextureLayout,l9_196).xy,0.0);
}
#endif
l9_191=l9_197;
}
...
{
vec4 l9_199=l9_191;
l9_199.x=l9_191.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_198=l9_199;
}
#else
{
...
#endif
vec3 l9_200=mix(l9_198.xyz,definedBlend(l9_198.xyz,l9_172.xyz).xyz,vec3(l9_173));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_202=vec4(mix(vec3(1.0),l9_172.xyz,vec3(l9_173)),l9_173);
}
#else
{
vec4 l9_203;
...
#endif
l9_203=vec4(l9_172.xyz*l9_204,l9_204);
}
#else
{
l9_203=l9_172;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_211-0.0039215689)),min(1.0,l9_211+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_213=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_212).xy);
float l9_214=packValue(l9_213);
int l9_221=int(l9_210.w*255.0);
float l9_222=packValue(l9_221);
sc_writeFragData0(vec4(packValue(l9_213),packValue(l9_213),packValue(l9_213),packValue(l9_213)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_225=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_225).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_230==0)
{
l9_233=texture(sc_OITAlpha0,l9_225);
l9_232=texture(sc_OITDepthLow0,l9_225);
l9_231=texture(sc_OITDepthHigh0,l9_225);
}
else
{
l9_233=vec4(0.0);
...
if (l9_230==1)
{
l9_236=texture(sc_OITAlpha1,l9_225);
l9_235=texture(sc_OITDepthLow1,l9_225);
l9_234=texture(sc_OITDepthHigh1,l9_225);
}
else
{
l9_236=l9_233;
...
vec4 l9_251=texture(sc_OITFilteredDepthBoundsTexture,l9_225);
