...
vec4 l9_17=param_3;
vec4 l9_18=l9_17*vec4(colorMultiplier+1.0);
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_24=clamp(l9_17.w*2.0,0.0,1.0);
}
#else
{
float l9_25;
...
{
l9_25=clamp(dot(l9_19.xyz,vec3(l9_17.w)),0.0,1.0);
}
#else
{
float l9_26;
...
#if (sc_BlendMode_Multiply)
{
l9_27=(1.0-dot(l9_19.xyz,vec3(0.33333001)))*l9_17.w;
}
#else
{
float l9_28;
...
{
l9_28=(1.0-clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0))*l9_17.w;
}
#else
{
float l9_29;
#if (sc_BlendMode_ColoredGlass)
{
l9_29=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*l9_17.w;
}
#else
{
float l9_30;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_31=clamp(dot(l9_19.xyz,vec3(1.0)),0.0,1.0)*l9_17.w;
}
#else
{
float l9_32;
...
{
l9_32=dot(l9_19.xyz,vec3(0.33333001))*l9_17.w;
}
#else
{
float l9_33;
...
{
vec3 l9_37=sc_GetFramebufferColor().xyz;
vec3 l9_38=mix(l9_37,definedBlend(l9_37,l9_19.xyz).xyz,vec3(l9_17.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_40=vec4(mix(vec3(1.0),l9_19.xyz,vec3(l9_17.w)),l9_17.w);
}
#else
{
vec4 l9_41;
...
#endif
l9_41=vec4(l9_19.xyz*l9_42,l9_42);
}
#else
{
l9_41=l9_19;
