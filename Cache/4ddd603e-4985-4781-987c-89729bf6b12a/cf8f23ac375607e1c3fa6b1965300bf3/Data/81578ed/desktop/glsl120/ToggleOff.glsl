...
vec4 l9_3=param_3;
vec4 l9_4=l9_3*vec4(colorMultiplier+1.0);
...
{
l9_9=clamp(dot(l9_5.xyz,vec3(l9_3.w)),0.0,1.0);
}
#else
{
float l9_10;
...
#if (sc_BlendMode_Multiply)
{
l9_11=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*l9_3.w;
}
#else
{
float l9_12;
...
{
l9_12=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*l9_3.w;
}
#else
{
float l9_13;
#if (sc_BlendMode_ColoredGlass)
{
l9_13=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_14;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_15=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_3.w;
}
#else
{
float l9_16;
...
{
l9_16=dot(l9_5.xyz,vec3(0.33333001))*l9_3.w;
}
#else
{
float l9_17;
...
vec3 l9_22=mix(l9_21,definedBlend(l9_21,l9_5.xyz).xyz,vec3(l9_3.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_24=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_3.w)),l9_3.w);
}
#else
{
vec4 l9_25;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_34=sc_ScreenCoordsGlobalToView(l9_2);
...
#if (sc_OITCompositingPass)
{
vec2 l9_47=sc_ScreenCoordsGlobalToView(l9_2);
#if (sc_OITMaxLayers4Plus1)
{
