...
{
float l9_20=l9_18.x;
sc_SoftwareWrapEarly(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_21=l9_20;
float l9_22=l9_18.y;
sc_SoftwareWrapEarly(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_23=l9_22;
vec2 l9_24;
float l9_25;
...
{
l9_26=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_26=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_27=l9_21;
float l9_28=1.0;
sc_ClampUV(l9_27,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_26,l9_28);
float l9_29=l9_27;
float l9_30=l9_28;
bool l9_31;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_31=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_31=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_32=l9_23;
float l9_33=l9_30;
sc_ClampUV(l9_32,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_31,l9_33);
l9_25=l9_33;
...
#endif
vec2 l9_34=sc_TransformUV(l9_24,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_35=l9_34.x;
float l9_36=l9_25;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_36);
float l9_37=l9_34.y;
float l9_38=l9_36;
sc_SoftwareWrapLate(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_38);
float l9_39=l9_38;
vec3 l9_40=sc_SamplingCoordsViewToGlobal(vec2(l9_35,l9_37),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_41=texture(planet_refl_mapArrSC,l9_40,0.0);
vec4 l9_42;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_42=mix(planet_refl_mapBorderColor,l9_41,vec4(l9_39));
}
#else
{
l9_42=l9_41;
...
{
float l9_43=l9_18.x;
sc_SoftwareWrapEarly(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_44=l9_43;
float l9_45=l9_18.y;
sc_SoftwareWrapEarly(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_46=l9_45;
vec2 l9_47;
float l9_48;
#if (SC_USE_UV_MIN_MAX_planet_refl_map)
...
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_49=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
...
float l9_50=l9_44;
float l9_51=1.0;
sc_ClampUV(l9_50,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_49,l9_51);
float l9_52=l9_50;
float l9_53=l9_51;
bool l9_54;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_54=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_54=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_55=l9_46;
float l9_56=l9_53;
sc_ClampUV(l9_55,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_54,l9_56);
l9_48=l9_56;
...
#endif
vec2 l9_57=sc_TransformUV(l9_47,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_58=l9_57.x;
float l9_59=l9_48;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_59);
float l9_60=l9_57.y;
float l9_61=l9_59;
sc_SoftwareWrapLate(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0)),l9_61);
float l9_62=l9_61;
vec3 l9_63=sc_SamplingCoordsViewToGlobal(vec2(l9_58,l9_60),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_64=texture(planet_refl_map,l9_63.xy,0.0);
vec4 l9_65;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_65=mix(planet_refl_mapBorderColor,l9_64,vec4(l9_62));
}
#else
{
l9_65=l9_64;
...
#endif
vec4 l9_66=vec4(reflIntensity)*l9_19;
float l9_67=radians(Port_Rotation_N003);
vec2 l9_68=l9_2-Port_Center_N003;
float l9_69=clamp((vec2(dot(vec2(cos(l9_67),sin(l9_67)),l9_68),0.0)+Port_Center_N003).x,0.0,1.0);
vec4 l9_70;
if (l9_69<colorRatio)
{
l9_70=mix(Tweak_N2,Tweak_N8,vec4(clamp(l9_69/colorRatio,0.0,1.0)));
}
else
{
l9_70=mix(Tweak_N8,Tweak_N9,vec4(clamp((l9_69-colorRatio)/(1.0-colorRatio),0.0,1.0)));
}
bool l9_71=PreviewEnabled==1;
bool l9_72;
if (l9_71)
{
l9_72=!l9_0;
...
vec4 l9_76=l9_66+l9_70;
vec4 l9_77;
#if (Tweak_N6Layout==2)
{
float l9_78=l9_1.x;
sc_SoftwareWrapEarly(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_79=l9_78;
float l9_80=l9_1.y;
sc_SoftwareWrapEarly(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_81=l9_80;
vec2 l9_82;
float l9_83;
...
{
l9_84=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_84=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_85=l9_79;
float l9_86=1.0;
sc_ClampUV(l9_85,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_84,l9_86);
float l9_87=l9_85;
float l9_88=l9_86;
bool l9_89;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_89=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_89=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_90=l9_81;
float l9_91=l9_88;
sc_ClampUV(l9_90,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_89,l9_91);
l9_83=l9_91;
...
#endif
vec2 l9_92=sc_TransformUV(l9_82,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_93=l9_92.x;
float l9_94=l9_83;
sc_SoftwareWrapLate(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_94);
float l9_95=l9_92.y;
float l9_96=l9_94;
sc_SoftwareWrapLate(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_96);
float l9_97=l9_96;
vec3 l9_98=sc_SamplingCoordsViewToGlobal(vec2(l9_93,l9_95),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_99=texture(Tweak_N6ArrSC,l9_98,0.0);
vec4 l9_100;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_100=mix(Tweak_N6BorderColor,l9_99,vec4(l9_97));
}
#else
{
l9_100=l9_99;
...
{
float l9_101=l9_1.x;
sc_SoftwareWrapEarly(l9_101,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_102=l9_101;
float l9_103=l9_1.y;
sc_SoftwareWrapEarly(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_104=l9_103;
vec2 l9_105;
float l9_106;
#if (SC_USE_UV_MIN_MAX_Tweak_N6)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_107=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_107=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_108=l9_102;
float l9_109=1.0;
sc_ClampUV(l9_108,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_107,l9_109);
float l9_110=l9_108;
float l9_111=l9_109;
bool l9_112;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_112=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
...
float l9_113=l9_104;
float l9_114=l9_111;
sc_ClampUV(l9_113,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_112,l9_114);
l9_106=l9_114;
...
#endif
vec2 l9_115=sc_TransformUV(l9_105,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_116=l9_115.x;
float l9_117=l9_106;
sc_SoftwareWrapLate(l9_116,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_117);
float l9_118=l9_115.y;
float l9_119=l9_117;
sc_SoftwareWrapLate(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0)),l9_119);
float l9_120=l9_119;
vec3 l9_121=sc_SamplingCoordsViewToGlobal(vec2(l9_116,l9_118),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_122=texture(Tweak_N6,l9_121.xy,0.0);
vec4 l9_123;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_123=mix(Tweak_N6BorderColor,l9_122,vec4(l9_120));
}
#else
{
l9_123=l9_122;
...
#endif
vec3 l9_124=l9_76.xyz;
vec3 l9_125=mix(l9_124,(l9_77.xyz*l9_124).xyz,vec3(l9_77.w));
float l9_126=l9_76.w;
vec4 l9_127=vec4(l9_125.x,l9_125.y,l9_125.z,vec4(0.0).w);
l9_127.w=l9_126;
...
#endif
sc_writeFragData0(max(l9_128,vec4(0.0)));
return;
}
vec4 l9_130;
...
#if (sc_FramebufferFetch)
{
vec4 l9_146=sc_readFragData0_Platform();
vec4 l9_147;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_148=l9_146;
l9_148.x=l9_146.x+_sc_framebufferFetchMarker;
l9_147=l9_148;
}
#else
{
...
{
l9_151=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_149,sc_ScreenTextureLayout,l9_150),0.0);
}
#else
{
l9_151=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_149,sc_ScreenTextureLayout,l9_150).xy,0.0);
}
#endif
l9_145=l9_151;
}
...
{
vec4 l9_153=l9_145;
l9_153.x=l9_145.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_152=l9_153;
}
#else
{
...
#endif
vec3 l9_154=mix(l9_152.xyz,definedBlend(l9_152.xyz,l9_127.xyz).xyz,vec3(l9_126));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_156=vec4(mix(vec3(1.0),l9_127.xyz,vec3(l9_126)),l9_126);
}
#else
{
vec4 l9_157;
...
#endif
l9_157=vec4(l9_127.xyz*l9_158,l9_158);
}
#else
{
l9_157=l9_127;
