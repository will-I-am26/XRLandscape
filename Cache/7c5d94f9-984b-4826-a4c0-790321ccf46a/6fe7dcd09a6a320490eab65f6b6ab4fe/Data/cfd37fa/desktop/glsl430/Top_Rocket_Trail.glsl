...
{
float l9_18=l9_16.x;
sc_SoftwareWrapEarly(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x);
float l9_19=l9_18;
float l9_20=l9_16.y;
sc_SoftwareWrapEarly(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y);
float l9_21=l9_20;
vec2 l9_22;
float l9_23;
...
{
l9_24=ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x==3;
}
#else
{
...
float l9_25=l9_19;
float l9_26=1.0;
sc_ClampUV(l9_25,texture_mapUvMinMax.x,texture_mapUvMinMax.z,l9_24,l9_26);
float l9_27=l9_25;
float l9_28=l9_26;
bool l9_29;
#if (SC_USE_CLAMP_TO_BORDER_texture_map)
{
l9_29=ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y==3;
}
#else
{
l9_29=(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0);
}
#endif
float l9_30=l9_21;
float l9_31=l9_28;
sc_ClampUV(l9_30,texture_mapUvMinMax.y,texture_mapUvMinMax.w,l9_29,l9_31);
l9_23=l9_31;
...
#endif
vec2 l9_32=sc_TransformUV(l9_22,(int(SC_USE_UV_TRANSFORM_texture_map)!=0),texture_mapTransform);
float l9_33=l9_32.x;
float l9_34=l9_23;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x,(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_texture_map)!=0)),l9_34);
float l9_35=l9_32.y;
float l9_36=l9_34;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y,(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_texture_map)!=0)),l9_36);
float l9_37=l9_36;
vec3 l9_38=sc_SamplingCoordsViewToGlobal(vec2(l9_33,l9_35),texture_mapLayout,texture_mapGetStereoViewIndex());
vec4 l9_39=texture(texture_mapArrSC,l9_38,0.0);
vec4 l9_40;
#if (SC_USE_CLAMP_TO_BORDER_texture_map)
{
l9_40=mix(texture_mapBorderColor,l9_39,vec4(l9_37));
}
#else
{
l9_40=l9_39;
...
float l9_56=l9_55.x;
float l9_57=l9_46;
sc_SoftwareWrapLate(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).x,(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_texture_map)!=0)),l9_57);
float l9_58=l9_55.y;
float l9_59=l9_57;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_texture_map,SC_SOFTWARE_WRAP_MODE_V_texture_map).y,(int(SC_USE_CLAMP_TO_BORDER_texture_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_texture_map)!=0)),l9_59);
float l9_60=l9_59;
...
vec4 l9_66=vec4(l9_8.x,l9_8.y,l9_8.z,vec4(0.0).w);
l9_66.w=l9_65;
...
#endif
vec3 l9_93=mix(l9_91.xyz,definedBlend(l9_91.xyz,l9_66.xyz).xyz,vec3(l9_65));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_95=vec4(mix(vec3(1.0),l9_66.xyz,vec3(l9_65)),l9_65);
}
#else
{
vec4 l9_96;
...
#endif
l9_96=vec4(l9_66.xyz*l9_97,l9_97);
}
#else
{
l9_96=l9_66;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_104-0.0039215689)),min(1.0,l9_104+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_106),packValue(l9_106),packValue(l9_106),packValue(l9_106)));
