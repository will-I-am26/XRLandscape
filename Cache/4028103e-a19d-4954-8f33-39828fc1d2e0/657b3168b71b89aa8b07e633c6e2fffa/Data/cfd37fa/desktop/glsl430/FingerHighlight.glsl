...
{
float l9_3=l9_0.x;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).x);
float l9_4=l9_3;
float l9_5=l9_0.y;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).y);
float l9_6=l9_5;
vec2 l9_7;
float l9_8;
...
{
l9_9=ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).x==3;
}
#else
{
l9_9=(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0);
}
#endif
float l9_10=l9_4;
float l9_11=1.0;
sc_ClampUV(l9_10,fingertipUvMinMax.x,fingertipUvMinMax.z,l9_9,l9_11);
float l9_12=l9_10;
float l9_13=l9_11;
bool l9_14;
#if (SC_USE_CLAMP_TO_BORDER_fingertip)
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).y==3;
}
#else
{
l9_14=(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0);
}
#endif
float l9_15=l9_6;
float l9_16=l9_13;
sc_ClampUV(l9_15,fingertipUvMinMax.y,fingertipUvMinMax.w,l9_14,l9_16);
l9_8=l9_16;
...
#endif
vec2 l9_17=sc_TransformUV(l9_7,(int(SC_USE_UV_TRANSFORM_fingertip)!=0),fingertipTransform);
float l9_18=l9_17.x;
float l9_19=l9_8;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).x,(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0)&&(!(int(SC_USE_UV_MIN_MAX_fingertip)!=0)),l9_19);
float l9_20=l9_17.y;
float l9_21=l9_19;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).y,(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0)&&(!(int(SC_USE_UV_MIN_MAX_fingertip)!=0)),l9_21);
float l9_22=l9_21;
vec3 l9_23=sc_SamplingCoordsViewToGlobal(vec2(l9_18,l9_20),fingertipLayout,fingertipGetStereoViewIndex());
vec4 l9_24=texture(fingertipArrSC,l9_23,0.0);
vec4 l9_25;
#if (SC_USE_CLAMP_TO_BORDER_fingertip)
{
l9_25=mix(fingertipBorderColor,l9_24,vec4(l9_22));
}
#else
{
l9_25=l9_24;
...
{
float l9_26=l9_0.x;
sc_SoftwareWrapEarly(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).x);
float l9_27=l9_26;
float l9_28=l9_0.y;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).y);
float l9_29=l9_28;
vec2 l9_30;
float l9_31;
#if (SC_USE_UV_MIN_MAX_fingertip)
...
#if (SC_USE_CLAMP_TO_BORDER_fingertip)
{
l9_32=ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).x==3;
}
#else
{
l9_32=(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0);
}
#endif
float l9_33=l9_27;
float l9_34=1.0;
sc_ClampUV(l9_33,fingertipUvMinMax.x,fingertipUvMinMax.z,l9_32,l9_34);
float l9_35=l9_33;
float l9_36=l9_34;
bool l9_37;
#if (SC_USE_CLAMP_TO_BORDER_fingertip)
{
l9_37=ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).y==3;
}
#else
{
l9_37=(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0);
}
#endif
float l9_38=l9_29;
float l9_39=l9_36;
sc_ClampUV(l9_38,fingertipUvMinMax.y,fingertipUvMinMax.w,l9_37,l9_39);
l9_31=l9_39;
...
#endif
vec2 l9_40=sc_TransformUV(l9_30,(int(SC_USE_UV_TRANSFORM_fingertip)!=0),fingertipTransform);
float l9_41=l9_40.x;
float l9_42=l9_31;
sc_SoftwareWrapLate(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).x,(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0)&&(!(int(SC_USE_UV_MIN_MAX_fingertip)!=0)),l9_42);
float l9_43=l9_40.y;
float l9_44=l9_42;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_fingertip,SC_SOFTWARE_WRAP_MODE_V_fingertip).y,(int(SC_USE_CLAMP_TO_BORDER_fingertip)!=0)&&(!(int(SC_USE_UV_MIN_MAX_fingertip)!=0)),l9_44);
float l9_45=l9_44;
vec3 l9_46=sc_SamplingCoordsViewToGlobal(vec2(l9_41,l9_43),fingertipLayout,fingertipGetStereoViewIndex());
vec4 l9_47=texture(fingertip,l9_46.xy,0.0);
vec4 l9_48;
#if (SC_USE_CLAMP_TO_BORDER_fingertip)
{
l9_48=mix(fingertipBorderColor,l9_47,vec4(l9_45));
}
#else
{
l9_48=l9_47;
...
{
float l9_50=l9_0.x;
sc_SoftwareWrapEarly(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x);
float l9_51=l9_50;
float l9_52=l9_0.y;
sc_SoftwareWrapEarly(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y);
float l9_53=l9_52;
vec2 l9_54;
float l9_55;
...
{
l9_56=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x==3;
}
#else
{
l9_56=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_57=l9_51;
float l9_58=1.0;
sc_ClampUV(l9_57,handGlowTexUvMinMax.x,handGlowTexUvMinMax.z,l9_56,l9_58);
float l9_59=l9_57;
float l9_60=l9_58;
bool l9_61;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_61=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y==3;
}
#else
{
l9_61=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_62=l9_53;
float l9_63=l9_60;
sc_ClampUV(l9_62,handGlowTexUvMinMax.y,handGlowTexUvMinMax.w,l9_61,l9_63);
l9_55=l9_63;
l9_54=vec2(l9_59,l9_62);
}
#else
...
#endif
vec2 l9_64=sc_TransformUV(l9_54,(int(SC_USE_UV_TRANSFORM_handGlowTex)!=0),handGlowTexTransform);
float l9_65=l9_64.x;
float l9_66=l9_55;
sc_SoftwareWrapLate(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x,(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0)),l9_66);
float l9_67=l9_64.y;
float l9_68=l9_66;
sc_SoftwareWrapLate(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y,(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0)),l9_68);
float l9_69=l9_68;
vec3 l9_70=sc_SamplingCoordsViewToGlobal(vec2(l9_65,l9_67),handGlowTexLayout,handGlowTexGetStereoViewIndex());
vec4 l9_71=texture(handGlowTexArrSC,l9_70,0.0);
vec4 l9_72;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_72=mix(handGlowTexBorderColor,l9_71,vec4(l9_69));
}
#else
{
l9_72=l9_71;
...
{
float l9_73=l9_0.x;
sc_SoftwareWrapEarly(l9_73,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x);
float l9_74=l9_73;
float l9_75=l9_0.y;
sc_SoftwareWrapEarly(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y);
float l9_76=l9_75;
vec2 l9_77;
float l9_78;
#if (SC_USE_UV_MIN_MAX_handGlowTex)
...
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_79=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x==3;
}
#else
{
l9_79=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_80=l9_74;
float l9_81=1.0;
sc_ClampUV(l9_80,handGlowTexUvMinMax.x,handGlowTexUvMinMax.z,l9_79,l9_81);
float l9_82=l9_80;
float l9_83=l9_81;
bool l9_84;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_84=ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y==3;
}
#else
{
l9_84=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0);
}
#endif
float l9_85=l9_76;
float l9_86=l9_83;
sc_ClampUV(l9_85,handGlowTexUvMinMax.y,handGlowTexUvMinMax.w,l9_84,l9_86);
l9_78=l9_86;
l9_77=vec2(l9_82,l9_85);
}
#else
...
#endif
vec2 l9_87=sc_TransformUV(l9_77,(int(SC_USE_UV_TRANSFORM_handGlowTex)!=0),handGlowTexTransform);
float l9_88=l9_87.x;
float l9_89=l9_78;
sc_SoftwareWrapLate(l9_88,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).x,(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0)),l9_89);
float l9_90=l9_87.y;
float l9_91=l9_89;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex,SC_SOFTWARE_WRAP_MODE_V_handGlowTex).y,(int(SC_USE_CLAMP_TO_BORDER_handGlowTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_handGlowTex)!=0)),l9_91);
float l9_92=l9_91;
vec3 l9_93=sc_SamplingCoordsViewToGlobal(vec2(l9_88,l9_90),handGlowTexLayout,handGlowTexGetStereoViewIndex());
vec4 l9_94=texture(handGlowTex,l9_93.xy,0.0);
vec4 l9_95;
#if (SC_USE_CLAMP_TO_BORDER_handGlowTex)
{
l9_95=mix(handGlowTexBorderColor,l9_94,vec4(l9_92));
}
#else
{
l9_95=l9_94;
...
#endif
vec4 l9_96=mix(l9_2,l9_49,vec4(blend_coef));
float l9_97=mix(Port_Input0_N003,indexBrightness,l9_96.y);
vec4 l9_98=vec4(indexGlowColor.xyz,l9_97);
vec3 l9_99=l9_98.xyz*l9_97;
vec4 l9_100=vec4(l9_99.x,l9_99.y,l9_99.z,l9_98.w)+(vec4(thumbGlowColor.xyz,mix(Port_Input0_N011,thumbBrightness,l9_96.x))*(1.0-l9_97));
float l9_101=l9_100.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_101<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_101<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_102,vec4(0.0)));
return;
}
vec4 l9_104;
...
{
l9_106=clamp(l9_101*2.0,0.0,1.0);
}
#else
{
float l9_107;
...
{
l9_107=clamp(dot(l9_100.xyz,vec3(l9_101)),0.0,1.0);
}
#else
{
float l9_108;
...
{
l9_109=(1.0-dot(l9_100.xyz,vec3(0.33333001)))*l9_101;
}
#else
{
float l9_110;
...
{
l9_110=(1.0-clamp(dot(l9_100.xyz,vec3(1.0)),0.0,1.0))*l9_101;
}
#else
{
float l9_111;
...
{
l9_111=clamp(dot(l9_100.xyz,vec3(1.0)),0.0,1.0)*l9_101;
}
#else
{
float l9_112;
#if (sc_BlendMode_Add)
{
l9_112=clamp(dot(l9_100.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_113;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_113=clamp(dot(l9_100.xyz,vec3(1.0)),0.0,1.0)*l9_101;
}
#else
{
float l9_114;
...
{
l9_114=dot(l9_100.xyz,vec3(0.33333001))*l9_101;
}
#else
{
float l9_115;
#if (sc_BlendMode_Min)
{
l9_115=1.0-clamp(dot(l9_100.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_116;
#if (sc_BlendMode_Max)
{
l9_116=clamp(dot(l9_100.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_116=1.0;
...
#endif
l9_104=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_100.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_105);
}
#else
{
vec4 l9_117;
...
#endif
vec3 l9_128=mix(l9_126.xyz,definedBlend(l9_126.xyz,l9_100.xyz).xyz,vec3(l9_101));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_130=vec4(mix(vec3(1.0),l9_100.xyz,vec3(l9_101)),l9_101);
}
#else
{
vec4 l9_131;
...
#endif
l9_131=vec4(l9_100.xyz*l9_132,l9_132);
}
#else
{
l9_131=l9_100;
...
{
l9_135=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_135=vec4(0.0);
...
vec4 l9_137=outputMotionVectorsIfNeeded(varPos,max(l9_136,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_139-0.0039215689)),min(1.0,l9_139+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_141=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_140).xy);
float l9_142=packValue(l9_141);
int l9_149=int(l9_138.w*255.0);
float l9_150=packValue(l9_149);
sc_writeFragData0(vec4(packValue(l9_141),packValue(l9_141),packValue(l9_141),packValue(l9_141)));
...
if (l9_158==0)
{
l9_161=texture(sc_OITAlpha0,l9_153);
l9_160=texture(sc_OITDepthLow0,l9_153);
l9_159=texture(sc_OITDepthHigh0,l9_153);
}
else
{
l9_161=vec4(0.0);
...
if (l9_158==1)
{
l9_164=texture(sc_OITAlpha1,l9_153);
l9_163=texture(sc_OITDepthLow1,l9_153);
l9_162=texture(sc_OITDepthHigh1,l9_153);
}
else
{
l9_164=l9_161;
...
vec4 l9_179=texture(sc_OITFilteredDepthBoundsTexture,l9_153);
