...
vec2 l9_113=l9_3*Port_Input1_N028;
float l9_114=clamp(length(l9_113+Port_Input2_N028),0.0,1.0);
vec4 l9_115;
if (l9_114<Port_Position1_N031)
{
l9_115=mix(Port_Value0_N031,Port_Value1_N031,vec4(clamp(l9_114/Port_Position1_N031,0.0,1.0)));
}
else
{
vec4 l9_116;
if (l9_114<Port_Position2_N031)
{
l9_116=mix(Port_Value1_N031,Port_Value2_N031,vec4(clamp((l9_114-Port_Position1_N031)/(Port_Position2_N031-Port_Position1_N031),0.0,1.0)));
}
else
{
vec4 l9_117;
if (l9_114<Port_Position3_N031)
{
l9_117=mix(Port_Value2_N031,Port_Value3_N031,vec4(clamp((l9_114-Port_Position2_N031)/(Port_Position3_N031-Port_Position2_N031),0.0,1.0)));
}
else
{
l9_117=mix(Port_Value3_N031,Port_Value4_N031,vec4(clamp((l9_114-Port_Position3_N031)/(1.0-Port_Position3_N031),0.0,1.0)));
}
l9_116=l9_117;
}
l9_115=l9_116;
}
vec3 l9_118=l9_11*Port_Import_N041;
...
float l9_140=l9_129;
sc_SoftwareWrapLate(l9_139,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0)),l9_140);
float l9_141=l9_138.y;
float l9_142=l9_140;
sc_SoftwareWrapLate(l9_141,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0)),l9_142);
float l9_143=l9_142;
...
float l9_163=l9_152;
sc_SoftwareWrapLate(l9_162,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0)),l9_163);
float l9_164=l9_161.y;
float l9_165=l9_163;
sc_SoftwareWrapLate(l9_164,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0)),l9_165);
float l9_166=l9_165;
...
#endif
vec4 l9_170=vec4(Port_Import_N027)*l9_123;
float l9_171=clamp(((l9_170.xy*Port_Input1_N008)+Port_Input2_N008).x,0.0,1.0);
vec4 l9_172;
if (l9_171<Port_Position1_N005)
{
l9_172=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_171/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_173;
if (l9_171<Port_Position2_N005)
{
l9_173=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_171-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_173=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_171-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_172=l9_173;
}
vec3 l9_174=-l9_4;
vec4 l9_175=mix(l9_172,Port_Input1_N065,vec4(max(pow(1.0-abs(dot(l9_174,l9_11*Port_Normal_N064)),Port_Exponent_N064),0.0)*Port_Intensity_N064));
vec4 l9_176=l9_115+l9_175;
float l9_177;
if (l9_114<Port_Position1_N016)
{
l9_177=mix(Port_Value0_N016,Port_Value1_N016,clamp(l9_114/Port_Position1_N016,0.0,1.0));
}
else
{
float l9_178;
if (l9_114<Port_Position2_N016)
{
l9_178=mix(Port_Value1_N016,Port_Value2_N016,clamp((l9_114-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0));
}
else
{
float l9_179;
if (l9_114<Port_Position3_N016)
{
l9_179=mix(Port_Value2_N016,Port_Value3_N016,clamp((l9_114-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0));
}
else
{
l9_179=mix(Port_Value3_N016,Port_Value4_N016,clamp((l9_114-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0));
}
l9_178=l9_179;
}
l9_177=l9_178;
}
vec4 l9_180=vec4(l9_176.x,l9_176.y,l9_176.z,vec4(0.0).w);
l9_180.w=l9_177;
vec4 l9_181=l9_112+l9_180;
float l9_182=l9_181.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_182<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_182<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_183,vec4(0.0)));
return;
}
vec4 l9_185;
...
{
l9_187=clamp(l9_182*2.0,0.0,1.0);
}
#else
{
float l9_188;
...
{
l9_188=clamp(dot(l9_181.xyz,vec3(l9_182)),0.0,1.0);
}
#else
{
float l9_189;
...
{
l9_190=(1.0-dot(l9_181.xyz,vec3(0.33333001)))*l9_182;
}
#else
{
float l9_191;
...
{
l9_191=(1.0-clamp(dot(l9_181.xyz,vec3(1.0)),0.0,1.0))*l9_182;
}
#else
{
float l9_192;
...
{
l9_192=clamp(dot(l9_181.xyz,vec3(1.0)),0.0,1.0)*l9_182;
}
#else
{
float l9_193;
#if (sc_BlendMode_Add)
{
l9_193=clamp(dot(l9_181.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_194;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_194=clamp(dot(l9_181.xyz,vec3(1.0)),0.0,1.0)*l9_182;
}
#else
{
float l9_195;
...
{
l9_195=dot(l9_181.xyz,vec3(0.33333001))*l9_182;
}
#else
{
float l9_196;
#if (sc_BlendMode_Min)
{
l9_196=1.0-clamp(dot(l9_181.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_197;
#if (sc_BlendMode_Max)
{
l9_197=clamp(dot(l9_181.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_197=1.0;
...
#endif
l9_185=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_181.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_186);
}
#else
{
vec4 l9_198;
...
#if (sc_FramebufferFetch)
{
vec4 l9_201=sc_readFragData0_Platform();
vec4 l9_202;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_203=l9_201;
l9_203.x=l9_201.x+_sc_framebufferFetchMarker;
l9_202=l9_203;
}
#else
{
...
{
l9_205=1-sc_GetStereoViewIndex();
}
#else
{
l9_205=sc_GetStereoViewIndex();
}
#endif
vec4 l9_206;
#if (sc_ScreenTextureLayout==2)
{
l9_206=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_204,sc_ScreenTextureLayout,l9_205),0.0);
}
#else
{
l9_206=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_204,sc_ScreenTextureLayout,l9_205).xy,0.0);
}
#endif
l9_200=l9_206;
}
...
{
vec4 l9_208=l9_200;
l9_208.x=l9_200.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_207=l9_208;
}
#else
{
...
#endif
vec3 l9_209=mix(l9_207.xyz,definedBlend(l9_207.xyz,l9_181.xyz).xyz,vec3(l9_182));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_211=vec4(mix(vec3(1.0),l9_181.xyz,vec3(l9_182)),l9_182);
}
#else
{
vec4 l9_212;
...
#endif
l9_212=vec4(l9_181.xyz*l9_213,l9_213);
}
#else
{
l9_212=l9_181;
...
{
l9_216=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_216=vec4(0.0);
...
vec4 l9_218=outputMotionVectorsIfNeeded(varPos,max(l9_217,vec4(0.0)));
...
sc_writeFragData1(vec4(l9_223,packValue(l9_222),packValue(l9_222),packValue(l9_222)));
sc_writeFragData2(vec4(l9_231,packValue(l9_230),packValue(l9_230),packValue(l9_230)));
