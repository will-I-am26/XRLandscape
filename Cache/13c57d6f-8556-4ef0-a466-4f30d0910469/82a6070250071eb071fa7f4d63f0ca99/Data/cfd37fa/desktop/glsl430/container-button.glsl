...
{
float l9_12=l9_10.x;
sc_SoftwareWrapEarly(l9_12,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_13=l9_12;
float l9_14=l9_10.y;
sc_SoftwareWrapEarly(l9_14,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_15=l9_14;
vec2 l9_16;
float l9_17;
...
{
l9_18=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
...
float l9_19=l9_13;
float l9_20=1.0;
sc_ClampUV(l9_19,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_18,l9_20);
float l9_21=l9_19;
float l9_22=l9_20;
bool l9_23;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_23=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_23=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_24=l9_15;
float l9_25=l9_22;
sc_ClampUV(l9_24,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_23,l9_25);
l9_17=l9_25;
...
#endif
vec2 l9_26=sc_TransformUV(l9_16,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_27=l9_26.x;
float l9_28=l9_17;
sc_SoftwareWrapLate(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_28);
float l9_29=l9_26.y;
float l9_30=l9_28;
sc_SoftwareWrapLate(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_30);
float l9_31=l9_30;
vec3 l9_32=sc_SamplingCoordsViewToGlobal(vec2(l9_27,l9_29),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_33=texture(additional_settings_btn_refl_texArrSC,l9_32,0.0);
vec4 l9_34;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_34=mix(additional_settings_btn_refl_texBorderColor,l9_33,vec4(l9_31));
}
#else
{
l9_34=l9_33;
...
{
float l9_35=l9_10.x;
sc_SoftwareWrapEarly(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x);
float l9_36=l9_35;
float l9_37=l9_10.y;
sc_SoftwareWrapEarly(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y);
float l9_38=l9_37;
vec2 l9_39;
float l9_40;
#if (SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)
...
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_41=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x==3;
}
#else
{
l9_41=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_42=l9_36;
float l9_43=1.0;
sc_ClampUV(l9_42,additional_settings_btn_refl_texUvMinMax.x,additional_settings_btn_refl_texUvMinMax.z,l9_41,l9_43);
float l9_44=l9_42;
float l9_45=l9_43;
bool l9_46;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_46=ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y==3;
}
#else
{
l9_46=(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0);
}
#endif
float l9_47=l9_38;
float l9_48=l9_45;
sc_ClampUV(l9_47,additional_settings_btn_refl_texUvMinMax.y,additional_settings_btn_refl_texUvMinMax.w,l9_46,l9_48);
l9_40=l9_48;
...
#endif
vec2 l9_49=sc_TransformUV(l9_39,(int(SC_USE_UV_TRANSFORM_additional_settings_btn_refl_tex)!=0),additional_settings_btn_refl_texTransform);
float l9_50=l9_49.x;
float l9_51=l9_40;
sc_SoftwareWrapLate(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).x,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_51);
float l9_52=l9_49.y;
float l9_53=l9_51;
sc_SoftwareWrapLate(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex,SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex).y,(int(SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_additional_settings_btn_refl_tex)!=0)),l9_53);
float l9_54=l9_53;
vec3 l9_55=sc_SamplingCoordsViewToGlobal(vec2(l9_50,l9_52),additional_settings_btn_refl_texLayout,additional_settings_btn_refl_texGetStereoViewIndex());
vec4 l9_56=texture(additional_settings_btn_refl_tex,l9_55.xy,0.0);
vec4 l9_57;
#if (SC_USE_CLAMP_TO_BORDER_additional_settings_btn_refl_tex)
{
l9_57=mix(additional_settings_btn_refl_texBorderColor,l9_56,vec4(l9_54));
}
#else
{
l9_57=l9_56;
...
#endif
float l9_58=length((vec4(l9_3.xy,0.0,0.0).xy*Port_Input1_N009)+Port_Input2_N009);
vec4 l9_59=mix(Port_Value_N026,Port_Value_N027,vec4(triggered));
vec4 l9_60=max(l9_59,Port_Input1_N019);
float l9_61=clamp(l9_58,0.0,1.0);
vec4 l9_62;
if (l9_61<Port_Position1_N007)
{
l9_62=mix(l9_59,l9_60,vec4(clamp(l9_61/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_63;
...
{
l9_63=mix(l9_60,Port_Value2_N007,vec4(clamp((l9_61-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
...
vec4 l9_69=l9_11+l9_62;
vec4 l9_70=baseColor*l9_62;
float l9_71=clamp((l9_58*Port_Input1_N031)+0.001,Port_Input1_N028+0.001,Port_Input2_N028+0.001)-0.001;
float l9_72;
if (l9_71<=0.0)
{
l9_72=0.0;
...
{
l9_72=pow(l9_71,Port_Input1_N022);
}
float l9_73;
if (l9_72<=0.0)
{
...
{
l9_73=pow(l9_72,Port_Input1_N034);
}
float l9_74=l9_73*Port_Input1_N041;
vec2 l9_75=l9_2-Port_Center_N002;
vec2 l9_76=(l9_75*iconScale)+Port_Center_N002;
vec4 l9_77;
#if (iconLayout==2)
{
float l9_78=l9_76.x;
sc_SoftwareWrapEarly(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_79=l9_78;
float l9_80=l9_76.y;
...
float l9_93=l9_92.x;
float l9_94=l9_83;
sc_SoftwareWrapLate(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_94);
float l9_95=l9_92.y;
float l9_96=l9_94;
sc_SoftwareWrapLate(l9_95,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_96);
float l9_97=l9_96;
vec3 l9_98=sc_SamplingCoordsViewToGlobal(vec2(l9_93,l9_95),iconLayout,iconGetStereoViewIndex());
vec4 l9_99=texture(iconArrSC,l9_98,0.0);
vec4 l9_100;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
...
float l9_117=l9_106;
sc_SoftwareWrapLate(l9_116,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_117);
float l9_118=l9_115.y;
float l9_119=l9_117;
sc_SoftwareWrapLate(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_119);
float l9_120=l9_119;
...
#endif
vec4 l9_124=mix(mix(mix(baseColor*(l9_69*vec4(Port_Input1_N014)),clamp((vec4(Port_Input0_N038)-l9_70)+vec4(0.001),Port_Input1_N043+vec4(0.001),Port_Input2_N043+vec4(0.001))-vec4(0.001),vec4(isToggle*triggered)),hoverColor,vec4(hovered*l9_74)),vec4(l9_77.xyz,0.0),vec4(l9_77.w));
float l9_125=max(l9_72,mix(Port_Input0_N018,Port_Input1_N018,triggered));
float l9_126=max(l9_77.w,l9_125)*alpha;
vec4 l9_127=vec4(l9_124.x,l9_124.y,l9_124.z,vec4(0.0).w);
l9_127.w=l9_126;
