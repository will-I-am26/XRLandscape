...
float l9_166=clamp(((l9_165.xy*Port_Input1_N008)+Port_Input2_N008).x,0.0,1.0);
vec4 l9_167;
if (l9_166<Port_Position1_N005)
{
l9_167=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_166/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_168;
if (l9_166<Port_Position2_N005)
{
l9_168=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_166-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_168=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_166-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_167=l9_168;
}
vec3 l9_169=-l9_4;
vec4 l9_170=mix(l9_167,Port_Input1_N065,vec4(max(pow(1.0-abs(dot(l9_169,l9_11*Port_Normal_N064)),Port_Exponent_N064),0.0)*Port_Intensity_N064));
vec2 l9_171=l9_3*Port_Input1_N067;
float l9_172=clamp(length(l9_171+Port_Input2_N067),0.0,1.0);
vec4 l9_173;
if (l9_172<Port_Position1_N069)
{
l9_173=mix(Port_Value0_N069,Port_Value1_N069,vec4(clamp(l9_172/Port_Position1_N069,0.0,1.0)));
}
else
{
vec4 l9_174;
if (l9_172<Port_Position2_N069)
{
l9_174=mix(Port_Value1_N069,Port_Value2_N069,vec4(clamp((l9_172-Port_Position1_N069)/(Port_Position2_N069-Port_Position1_N069),0.0,1.0)));
}
else
{
vec4 l9_175;
if (l9_172<Port_Position3_N069)
{
l9_175=mix(Port_Value2_N069,Port_Value3_N069,vec4(clamp((l9_172-Port_Position2_N069)/(Port_Position3_N069-Port_Position2_N069),0.0,1.0)));
}
else
{
l9_175=mix(Port_Value3_N069,Port_Value4_N069,vec4(clamp((l9_172-Port_Position3_N069)/(1.0-Port_Position3_N069),0.0,1.0)));
}
l9_174=l9_175;
}
l9_173=l9_174;
}
vec4 l9_176=l9_170+l9_173;
vec2 l9_177=l9_3-vec2(Port_RangeMinA_N076);
float l9_178=radians(Port_Rotation_N090);
float l9_179=sin(l9_178);
float l9_180=cos(l9_178);
vec2 l9_181=Port_CoordsIn_N090-Port_Center_N090;
vec2 l9_182=Port_Import_N081-Port_Import_N079;
vec4 l9_183=l9_176+mix(mix(Port_Input0_N092,Port_Input1_N092,vec4(max(pow(1.0-abs(dot(l9_169,l9_11*Port_Normal_N091)),Port_Exponent_N091),0.0)*Port_Intensity_N091)),Port_Input1_N093,mix(Port_Import_N074,Port_Import_N075,vec4(smoothstep(Port_Input0_N087,Port_Input1_N087,clamp((dot(((((((l9_177/vec2(Port_RangeMaxA_N076-Port_RangeMinA_N076))*(Port_RangeMaxB_N076-Port_RangeMinB_N076))+vec2(Port_RangeMinB_N076))-Port_Center_N078)*(vec2(dot(vec2(l9_180,l9_179),l9_181),dot(vec2(-l9_179,l9_180),l9_181))+Port_Center_N090))+Port_Center_N078)-Port_Import_N079,l9_182)/dot(l9_182,l9_182))+0.001,Port_Input1_N086+0.001,Port_Input2_N086+0.001)-0.001))));
vec2 l9_184=l9_3*Port_Input1_N028;
float l9_185=clamp(length(l9_184+Port_Input2_N028),0.0,1.0);
float l9_186;
if (l9_185<Port_Position1_N016)
{
l9_186=mix(Port_Value0_N016,Port_Value1_N016,clamp(l9_185/Port_Position1_N016,0.0,1.0));
}
else
{
float l9_187;
if (l9_185<Port_Position2_N016)
{
l9_187=mix(Port_Value1_N016,Port_Value2_N016,clamp((l9_185-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0));
}
else
{
float l9_188;
if (l9_185<Port_Position3_N016)
{
l9_188=mix(Port_Value2_N016,Port_Value3_N016,clamp((l9_185-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0));
}
else
{
l9_188=mix(Port_Value3_N016,Port_Value4_N016,clamp((l9_185-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0));
}
l9_187=l9_188;
}
l9_186=l9_187;
}
vec4 l9_189=vec4(l9_183.x,l9_183.y,l9_183.z,vec4(0.0).w);
l9_189.w=l9_186;
vec4 l9_190=l9_112+l9_189;
float l9_191=l9_190.w;
...
#endif
sc_writeFragData0(max(l9_192,vec4(0.0)));
return;
}
vec4 l9_194;
...
{
l9_196=clamp(l9_191*2.0,0.0,1.0);
}
#else
{
float l9_197;
...
{
l9_197=clamp(dot(l9_190.xyz,vec3(l9_191)),0.0,1.0);
}
#else
{
float l9_198;
...
{
l9_199=(1.0-dot(l9_190.xyz,vec3(0.33333001)))*l9_191;
}
#else
{
float l9_200;
...
{
l9_200=(1.0-clamp(dot(l9_190.xyz,vec3(1.0)),0.0,1.0))*l9_191;
}
#else
{
float l9_201;
...
{
l9_201=clamp(dot(l9_190.xyz,vec3(1.0)),0.0,1.0)*l9_191;
}
#else
{
float l9_202;
#if (sc_BlendMode_Add)
{
l9_202=clamp(dot(l9_190.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_203;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_203=clamp(dot(l9_190.xyz,vec3(1.0)),0.0,1.0)*l9_191;
}
#else
{
float l9_204;
...
{
l9_204=dot(l9_190.xyz,vec3(0.33333001))*l9_191;
}
#else
{
float l9_205;
#if (sc_BlendMode_Min)
{
l9_205=1.0-clamp(dot(l9_190.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_206;
#if (sc_BlendMode_Max)
{
l9_206=clamp(dot(l9_190.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_206=1.0;
...
#endif
l9_194=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_190.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_195);
}
#else
{
vec4 l9_207;
...
#if (sc_FramebufferFetch)
{
vec4 l9_210=sc_readFragData0_Platform();
vec4 l9_211;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_212=l9_210;
l9_212.x=l9_210.x+_sc_framebufferFetchMarker;
l9_211=l9_212;
}
#else
{
...
{
l9_214=1-sc_GetStereoViewIndex();
}
#else
{
l9_214=sc_GetStereoViewIndex();
}
#endif
vec4 l9_215;
#if (sc_ScreenTextureLayout==2)
{
l9_215=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_213,sc_ScreenTextureLayout,l9_214),0.0);
}
#else
{
l9_215=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_213,sc_ScreenTextureLayout,l9_214).xy,0.0);
}
#endif
l9_209=l9_215;
}
...
{
vec4 l9_217=l9_209;
l9_217.x=l9_209.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_216=l9_217;
}
#else
{
...
#endif
vec3 l9_218=mix(l9_216.xyz,definedBlend(l9_216.xyz,l9_190.xyz).xyz,vec3(l9_191));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_220=vec4(mix(vec3(1.0),l9_190.xyz,vec3(l9_191)),l9_191);
}
#else
{
vec4 l9_221;
...
#endif
l9_221=vec4(l9_190.xyz*l9_222,l9_222);
}
#else
{
l9_221=l9_190;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_230=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_230).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_231=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_230).xy);
...
if (l9_248==0)
{
l9_251=texture(sc_OITAlpha0,l9_243);
l9_250=texture(sc_OITDepthLow0,l9_243);
l9_249=texture(sc_OITDepthHigh0,l9_243);
}
else
{
l9_251=vec4(0.0);
...
if (l9_248==1)
{
l9_254=texture(sc_OITAlpha1,l9_243);
l9_253=texture(sc_OITDepthLow1,l9_243);
l9_252=texture(sc_OITDepthHigh1,l9_243);
}
else
{
l9_254=l9_251;
...
vec4 l9_269=texture(sc_OITFilteredDepthBoundsTexture,l9_243);
