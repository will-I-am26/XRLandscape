...
vec2 l9_123=l9_5-Port_Input1_N085;
float l9_124=l9_122*max(smoothstep(blur,blur*Port_Input1_N098,length(max(abs(l9_123)-(boxSize-vec2(cornerRadius)),Port_Input1_N089))-cornerRadius),Port_Input1_N094);
vec4 l9_125=vec4(l9_65.x,l9_65.y,l9_65.z,vec4(0.0).w);
l9_125.w=l9_124;
vec2 l9_126=l9_5-Port_Input1_N046;
vec3 l9_127=smoothstep(Port_Input0_N073,Port_Input1_N073,vec3(distance(Port_Input0_N042,l9_126*vec2(Port_Input1_N047))));
float l9_128=l9_1*Port_Multiplier_N054;
float l9_129=sin(l9_128);
float l9_130=(max(((l9_129*Port_Input1_N078)*l9_129)*Port_Input1_N080,Port_Input1_N079)*Port_Input1_N057)+Port_Input1_N070;
float l9_131=l9_127.x;
float l9_132;
if (l9_131<=0.0)
{
l9_132=0.0;
...
vec3 l9_137=mix(vec3(l9_132,l9_134,l9_136),vec3(floor(fract(sin(floor(dot(floor((floor(l9_5*10000.0)*9.9999997e-05)*Port_Scale_N081),vec2(0.98000002,0.72000003))*10000.0)*9.9999997e-05)*437.58499)*10000.0)*9.9999997e-05),vec3(Port_Input2_N082));
vec4 l9_138=vec4(l9_137.x,l9_137.y,l9_137.z,vec4(0.0).w);
l9_138.w=l9_124;
vec4 l9_139=mix(l9_125,l9_138,vec4(Port_Input2_N045));
if ((step(l9_124,Port_Input1_N099)*1.0)!=0.0)
{
discard;
}
...
#endif
sc_writeFragData0(max(l9_141,vec4(0.0)));
return;
}
vec4 l9_143;
