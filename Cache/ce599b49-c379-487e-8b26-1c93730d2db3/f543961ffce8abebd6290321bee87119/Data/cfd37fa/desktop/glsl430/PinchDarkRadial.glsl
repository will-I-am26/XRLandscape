...
vec4 l9_205=l9_204*vec4(colorMultiplier+1.0);
float l9_206=l9_204.w;
vec4 l9_207=vec4(l9_205.x,l9_205.y,l9_205.z,vec4(0.0).w);
l9_207.w=l9_206;
if (isProxyMode)
{
vec4 l9_208;
...
#endif
sc_writeFragData0(max(l9_208,vec4(0.0)));
return;
}
vec4 l9_210;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_212=clamp(l9_206*2.0,0.0,1.0);
}
#else
{
float l9_213;
...
{
l9_213=clamp(dot(l9_207.xyz,vec3(l9_206)),0.0,1.0);
}
#else
{
float l9_214;
...
#if (sc_BlendMode_Multiply)
{
l9_215=(1.0-dot(l9_207.xyz,vec3(0.33333001)))*l9_206;
}
#else
{
float l9_216;
...
{
l9_216=(1.0-clamp(dot(l9_207.xyz,vec3(1.0)),0.0,1.0))*l9_206;
}
#else
{
float l9_217;
#if (sc_BlendMode_ColoredGlass)
{
l9_217=clamp(dot(l9_207.xyz,vec3(1.0)),0.0,1.0)*l9_206;
}
#else
{
float l9_218;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_219=clamp(dot(l9_207.xyz,vec3(1.0)),0.0,1.0)*l9_206;
}
#else
{
float l9_220;
...
{
l9_220=dot(l9_207.xyz,vec3(0.33333001))*l9_206;
}
#else
{
float l9_221;
...
vec3 l9_226=mix(l9_225,definedBlend(l9_225,l9_207.xyz).xyz,vec3(l9_206));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_228=vec4(mix(vec3(1.0),l9_207.xyz,vec3(l9_206)),l9_206);
}
#else
{
vec4 l9_229;
...
#endif
l9_229=vec4(l9_207.xyz*l9_230,l9_230);
}
#else
{
l9_229=l9_207;
...
{
l9_233=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_233=vec4(0.0);
...
vec4 l9_235=outputMotionVectorsIfNeeded(varPos,max(l9_234,vec4(0.0)));
vec4 l9_236=clamp(l9_235,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_237=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_237-0.0039215689)),min(1.0,l9_237+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_238=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_238).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_239=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_238).xy);
float l9_240=packValue(l9_239);
int l9_247=int(l9_236.w*255.0);
float l9_248=packValue(l9_247);
sc_writeFragData0(vec4(packValue(l9_239),packValue(l9_239),packValue(l9_239),packValue(l9_239)));
sc_writeFragData1(vec4(l9_240,packValue(l9_239),packValue(l9_239),packValue(l9_239)));
sc_writeFragData2(vec4(l9_248,packValue(l9_247),packValue(l9_247),packValue(l9_247)));
...
if (l9_256==0)
{
l9_259=texture(sc_OITAlpha0,l9_251);
l9_258=texture(sc_OITDepthLow0,l9_251);
l9_257=texture(sc_OITDepthHigh0,l9_251);
}
else
{
l9_259=vec4(0.0);
...
if (l9_256==1)
{
l9_262=texture(sc_OITAlpha1,l9_251);
l9_261=texture(sc_OITDepthLow1,l9_251);
l9_260=texture(sc_OITDepthHigh1,l9_251);
}
else
{
l9_262=l9_259;
...
if (any(notEqual(l9_260,vec4(0.0)))||any(notEqual(l9_261,vec4(0.0))))
{
int l9_263[8]=l9_252;
unpackValues(l9_260.w,l9_256,l9_263);
unpackValues(l9_260.z,l9_256,l9_263);
unpackValues(l9_260.y,l9_256,l9_263);
unpackValues(l9_260.x,l9_256,l9_263);
unpackValues(l9_261.w,l9_256,l9_263);
unpackValues(l9_261.z,l9_256,l9_263);
unpackValues(l9_261.y,l9_256,l9_263);
unpackValues(l9_261.x,l9_256,l9_263);
int l9_272[8]=l9_253;
unpackValues(l9_262.w,l9_256,l9_272);
unpackValues(l9_262.z,l9_256,l9_272);
unpackValues(l9_262.y,l9_256,l9_272);
unpackValues(l9_262.x,l9_256,l9_272);
}
l9_256++;
continue;
}
...
vec4 l9_277=texture(sc_OITFilteredDepthBoundsTexture,l9_251);
vec2 l9_278=l9_277.xy;
int l9_279;
#if (sc_SkinBonesCount>0)
{
l9_279=encodeDepth(((1.0-l9_277.x)*1000.0)+getDepthOrderingEpsilon(),l9_278);
}
#else
{
l9_279=0;
...
#endif
int l9_280=encodeDepth(viewSpaceDepth(),l9_278);
vec4 l9_281;
l9_281=l9_236*l9_236.w;
vec4 l9_282;
int l9_283=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_283<8)
{
int l9_284=l9_252[l9_283];
int l9_285=l9_280-l9_279;
bool l9_286=l9_284<l9_285;
bool l9_287;
if (l9_286)
{
l9_287=l9_252[l9_283]>0;
}
else
{
l9_287=l9_286;
...
if (l9_287)
{
vec3 l9_288=l9_281.xyz*(1.0-(float(l9_253[l9_283])/255.0));
l9_282=vec4(l9_288.x,l9_288.y,l9_288.z,l9_281.w);
}
else
{
l9_282=l9_281;
