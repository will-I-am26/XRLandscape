...
float l9_129=clamp(l9_122.x,0.0,1.0);
float l9_130;
if (l9_129<Port_Position1_N018)
{
l9_130=mix(Port_Value0_N018,Port_Value1_N018,clamp(l9_129/Port_Position1_N018,0.0,1.0));
}
else
{
float l9_131;
if (l9_129<Port_Position2_N018)
{
l9_131=mix(Port_Value1_N018,Port_Value2_N018,clamp((l9_129-Port_Position1_N018)/(Port_Position2_N018-Port_Position1_N018),0.0,1.0));
}
else
{
float l9_132;
if (l9_129<Port_Position3_N018)
{
l9_132=mix(Port_Value2_N018,Port_Value3_N018,clamp((l9_129-Port_Position2_N018)/(Port_Position3_N018-Port_Position2_N018),0.0,1.0));
}
else
{
l9_132=mix(Port_Value3_N018,Port_Value4_N018,clamp((l9_129-Port_Position3_N018)/(1.0-Port_Position3_N018),0.0,1.0));
}
l9_131=l9_132;
}
l9_130=l9_131;
}
vec4 l9_133=vec4(l9_122.x,l9_122.y,l9_122.z,vec4(0.0).w);
l9_133.w=l9_130;
vec3 l9_134=-l9_6;
vec2 l9_135=l9_5-Port_Center_N002;
vec2 l9_136=(l9_135*Port_Scale_N002)+Port_Center_N002;
vec4 l9_137;
#if (iconLayout==2)
{
float l9_138=l9_136.x;
sc_SoftwareWrapEarly(l9_138,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_139=l9_138;
float l9_140=l9_136.y;
...
float l9_154=l9_143;
sc_SoftwareWrapLate(l9_153,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_154);
float l9_155=l9_152.y;
float l9_156=l9_154;
sc_SoftwareWrapLate(l9_155,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_156);
float l9_157=l9_156;
...
float l9_177=l9_166;
sc_SoftwareWrapLate(l9_176,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_177);
float l9_178=l9_175.y;
float l9_179=l9_177;
sc_SoftwareWrapLate(l9_178,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_179);
float l9_180=l9_179;
...
#if (iconLayout==2)
{
float l9_186=l9_136.x;
sc_SoftwareWrapEarly(l9_186,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_187=l9_186;
float l9_188=l9_136.y;
sc_SoftwareWrapEarly(l9_188,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_189=l9_188;
vec2 l9_190;
float l9_191;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_192=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_193=l9_187;
float l9_194=1.0;
sc_ClampUV(l9_193,iconUvMinMax.x,iconUvMinMax.z,l9_192,l9_194);
float l9_195=l9_193;
float l9_196=l9_194;
bool l9_197;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_197=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
...
float l9_198=l9_189;
float l9_199=l9_196;
sc_ClampUV(l9_198,iconUvMinMax.y,iconUvMinMax.w,l9_197,l9_199);
l9_191=l9_199;
l9_190=vec2(l9_195,l9_198);
}
#else
{
l9_191=1.0;
l9_190=vec2(l9_187,l9_189);
}
#endif
vec2 l9_200=sc_TransformUV(l9_190,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_201=l9_200.x;
float l9_202=l9_191;
sc_SoftwareWrapLate(l9_201,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_202);
float l9_203=l9_200.y;
float l9_204=l9_202;
sc_SoftwareWrapLate(l9_203,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_204);
float l9_205=l9_204;
vec3 l9_206=sc_SamplingCoordsViewToGlobal(vec2(l9_201,l9_203),iconLayout,iconGetStereoViewIndex());
vec4 l9_207=texture(iconArrSC,l9_206,0.0);
vec4 l9_208;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_208=mix(iconBorderColor,l9_207,vec4(l9_205));
}
#else
{
l9_208=l9_207;
...
#else
{
float l9_209=l9_136.x;
sc_SoftwareWrapEarly(l9_209,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_210=l9_209;
float l9_211=l9_136.y;
sc_SoftwareWrapEarly(l9_211,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_212=l9_211;
vec2 l9_213;
float l9_214;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_215=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
...
float l9_216=l9_210;
float l9_217=1.0;
sc_ClampUV(l9_216,iconUvMinMax.x,iconUvMinMax.z,l9_215,l9_217);
float l9_218=l9_216;
float l9_219=l9_217;
bool l9_220;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_220=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
...
float l9_221=l9_212;
float l9_222=l9_219;
sc_ClampUV(l9_221,iconUvMinMax.y,iconUvMinMax.w,l9_220,l9_222);
l9_214=l9_222;
...
#endif
vec2 l9_223=sc_TransformUV(l9_213,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_224=l9_223.x;
float l9_225=l9_214;
sc_SoftwareWrapLate(l9_224,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_225);
float l9_226=l9_223.y;
float l9_227=l9_225;
sc_SoftwareWrapLate(l9_226,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_227);
float l9_228=l9_227;
vec3 l9_229=sc_SamplingCoordsViewToGlobal(vec2(l9_224,l9_226),iconLayout,iconGetStereoViewIndex());
vec4 l9_230=texture(icon,l9_229.xy,0.0);
vec4 l9_231;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_231=mix(iconBorderColor,l9_230,vec4(l9_228));
}
#else
{
l9_231=l9_230;
...
{
l9_184=Port_Input2_N003;
}
vec4 l9_232=vec4(l9_184);
vec4 l9_233=mix(mix(l9_66,l9_119,vec4(Port_Input2_N005))+mix(l9_133,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(l9_134,l9_13*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031)),l9_137,l9_232);
float l9_234=l9_233.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_234<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_234<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_235,vec4(0.0)));
return;
}
vec4 l9_237;
...
{
l9_239=clamp(l9_234*2.0,0.0,1.0);
}
#else
{
float l9_240;
...
{
l9_240=clamp(dot(l9_233.xyz,vec3(l9_234)),0.0,1.0);
}
#else
{
float l9_241;
...
{
l9_242=(1.0-dot(l9_233.xyz,vec3(0.33333001)))*l9_234;
}
#else
{
float l9_243;
...
{
l9_243=(1.0-clamp(dot(l9_233.xyz,vec3(1.0)),0.0,1.0))*l9_234;
}
#else
{
float l9_244;
...
{
l9_244=clamp(dot(l9_233.xyz,vec3(1.0)),0.0,1.0)*l9_234;
}
#else
{
float l9_245;
#if (sc_BlendMode_Add)
{
l9_245=clamp(dot(l9_233.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_246;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_246=clamp(dot(l9_233.xyz,vec3(1.0)),0.0,1.0)*l9_234;
}
#else
{
float l9_247;
...
{
l9_247=dot(l9_233.xyz,vec3(0.33333001))*l9_234;
}
#else
{
float l9_248;
#if (sc_BlendMode_Min)
{
l9_248=1.0-clamp(dot(l9_233.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_249;
#if (sc_BlendMode_Max)
{
l9_249=clamp(dot(l9_233.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_249=1.0;
...
#endif
l9_237=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_233.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_238);
}
#else
{
vec4 l9_250;
...
#if (sc_FramebufferFetch)
{
vec4 l9_253=sc_readFragData0_Platform();
vec4 l9_254;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_255=l9_253;
l9_255.x=l9_253.x+_sc_framebufferFetchMarker;
l9_254=l9_255;
}
#else
{
...
{
l9_257=1-sc_GetStereoViewIndex();
}
#else
{
l9_257=sc_GetStereoViewIndex();
}
#endif
vec4 l9_258;
#if (sc_ScreenTextureLayout==2)
{
l9_258=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_256,sc_ScreenTextureLayout,l9_257),0.0);
}
#else
{
l9_258=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_256,sc_ScreenTextureLayout,l9_257).xy,0.0);
}
#endif
l9_252=l9_258;
}
...
{
vec4 l9_260=l9_252;
l9_260.x=l9_252.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_259=l9_260;
}
#else
{
...
#endif
vec3 l9_261=mix(l9_259.xyz,definedBlend(l9_259.xyz,l9_233.xyz).xyz,vec3(l9_234));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_263=vec4(mix(vec3(1.0),l9_233.xyz,vec3(l9_234)),l9_234);
}
#else
{
vec4 l9_264;
...
#endif
l9_264=vec4(l9_233.xyz*l9_265,l9_265);
}
#else
{
l9_264=l9_233;
...
{
l9_268=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_268=vec4(0.0);
...
vec4 l9_270=outputMotionVectorsIfNeeded(varPos,max(l9_269,vec4(0.0)));
vec4 l9_271=clamp(l9_270,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_272=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_272-0.0039215689)),min(1.0,l9_272+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_273=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_273).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_274=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_273).xy);
float l9_275=packValue(l9_274);
int l9_282=int(l9_271.w*255.0);
float l9_283=packValue(l9_282);
sc_writeFragData0(vec4(packValue(l9_274),packValue(l9_274),packValue(l9_274),packValue(l9_274)));
sc_writeFragData1(vec4(l9_275,packValue(l9_274),packValue(l9_274),packValue(l9_274)));
sc_writeFragData2(vec4(l9_283,packValue(l9_282),packValue(l9_282),packValue(l9_282)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_286=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_286).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_291==0)
{
l9_294=texture(sc_OITAlpha0,l9_286);
l9_293=texture(sc_OITDepthLow0,l9_286);
l9_292=texture(sc_OITDepthHigh0,l9_286);
}
else
{
l9_294=vec4(0.0);
...
if (l9_291==1)
{
l9_297=texture(sc_OITAlpha1,l9_286);
l9_296=texture(sc_OITDepthLow1,l9_286);
l9_295=texture(sc_OITDepthHigh1,l9_286);
}
else
{
l9_297=l9_294;
...
if (any(notEqual(l9_295,vec4(0.0)))||any(notEqual(l9_296,vec4(0.0))))
{
int l9_298[8]=l9_287;
unpackValues(l9_295.w,l9_291,l9_298);
unpackValues(l9_295.z,l9_291,l9_298);
unpackValues(l9_295.y,l9_291,l9_298);
unpackValues(l9_295.x,l9_291,l9_298);
unpackValues(l9_296.w,l9_291,l9_298);
unpackValues(l9_296.z,l9_291,l9_298);
unpackValues(l9_296.y,l9_291,l9_298);
unpackValues(l9_296.x,l9_291,l9_298);
int l9_307[8]=l9_288;
unpackValues(l9_297.w,l9_291,l9_307);
unpackValues(l9_297.z,l9_291,l9_307);
unpackValues(l9_297.y,l9_291,l9_307);
unpackValues(l9_297.x,l9_291,l9_307);
}
l9_291++;
continue;
}
...
vec4 l9_312=texture(sc_OITFilteredDepthBoundsTexture,l9_286);
vec2 l9_313=l9_312.xy;
int l9_314;
#if (sc_SkinBonesCount>0)
{
l9_314=encodeDepth(((1.0-l9_312.x)*1000.0)+getDepthOrderingEpsilon(),l9_313);
}
#else
{
l9_314=0;
...
#endif
int l9_315=encodeDepth(viewSpaceDepth(),l9_313);
vec4 l9_316;
l9_316=l9_271*l9_271.w;
vec4 l9_317;
int l9_318=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_318<8)
{
int l9_319=l9_287[l9_318];
int l9_320=l9_315-l9_314;
bool l9_321=l9_319<l9_320;
bool l9_322;
if (l9_321)
{
l9_322=l9_287[l9_318]>0;
}
else
{
l9_322=l9_321;
...
if (l9_322)
{
vec3 l9_323=l9_316.xyz*(1.0-(float(l9_288[l9_318])/255.0));
l9_317=vec4(l9_323.x,l9_323.y,l9_323.z,l9_316.w);
}
else
{
l9_317=l9_316;
