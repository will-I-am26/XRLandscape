...
float l9_33=l9_32.x;
float l9_34=l9_23;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x,(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0)&&(!(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0)),l9_34);
float l9_35=l9_32.y;
float l9_36=l9_34;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y,(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0)&&(!(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0)),l9_36);
float l9_37=l9_36;
...
{
float l9_41=l9_16.x;
sc_SoftwareWrapEarly(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x);
float l9_42=l9_41;
float l9_43=l9_16.y;
sc_SoftwareWrapEarly(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y);
float l9_44=l9_43;
vec2 l9_45;
float l9_46;
#if (SC_USE_UV_MIN_MAX_simple_round_button)
...
#if (SC_USE_CLAMP_TO_BORDER_simple_round_button)
{
l9_47=ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x==3;
}
#else
{
l9_47=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0);
}
#endif
float l9_48=l9_42;
float l9_49=1.0;
sc_ClampUV(l9_48,simple_round_buttonUvMinMax.x,simple_round_buttonUvMinMax.z,l9_47,l9_49);
float l9_50=l9_48;
float l9_51=l9_49;
bool l9_52;
#if (SC_USE_CLAMP_TO_BORDER_simple_round_button)
{
l9_52=ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y==3;
}
#else
{
l9_52=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0);
}
#endif
float l9_53=l9_44;
float l9_54=l9_51;
sc_ClampUV(l9_53,simple_round_buttonUvMinMax.y,simple_round_buttonUvMinMax.w,l9_52,l9_54);
l9_46=l9_54;
...
#endif
vec2 l9_55=sc_TransformUV(l9_45,(int(SC_USE_UV_TRANSFORM_simple_round_button)!=0),simple_round_buttonTransform);
float l9_56=l9_55.x;
float l9_57=l9_46;
sc_SoftwareWrapLate(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x,(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0)&&(!(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0)),l9_57);
float l9_58=l9_55.y;
float l9_59=l9_57;
sc_SoftwareWrapLate(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y,(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0)&&(!(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0)),l9_59);
float l9_60=l9_59;
vec3 l9_61=sc_SamplingCoordsViewToGlobal(vec2(l9_56,l9_58),simple_round_buttonLayout,simple_round_buttonGetStereoViewIndex());
vec4 l9_62=texture(simple_round_button,l9_61.xy,0.0);
vec4 l9_63;
#if (SC_USE_CLAMP_TO_BORDER_simple_round_button)
{
l9_63=mix(simple_round_buttonBorderColor,l9_62,vec4(l9_60));
}
#else
{
l9_63=l9_62;
...
#endif
vec4 l9_64=vec4(Port_Import_N027)*l9_17;
vec2 l9_65=l9_3*Port_Input1_N010;
float l9_66=clamp(length(l9_65+Port_Input2_N010),0.0,1.0);
vec4 l9_67;
if (l9_66<Port_Position1_N030)
{
l9_67=mix(Port_Value0_N030,Port_Value1_N030,vec4(clamp(l9_66/Port_Position1_N030,0.0,1.0)));
}
else
{
l9_67=mix(Port_Value1_N030,Port_Value2_N030,vec4(clamp((l9_66-Port_Position1_N030)/(1.0-Port_Position1_N030),0.0,1.0)));
}
vec3 l9_68=-l9_4;
vec4 l9_69=mix(l9_67,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(l9_68,l9_11*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_70=l9_69.w;
vec3 l9_71=(l9_64.xyz+Port_Input1_N002)+l9_69.xyz;
...
#endif
sc_writeFragData0(max(l9_73,vec4(0.0)));
return;
}
vec4 l9_75;
...
{
l9_78=clamp(dot(l9_72.xyz,vec3(l9_70)),0.0,1.0);
}
#else
{
float l9_79;
...
{
l9_80=(1.0-dot(l9_72.xyz,vec3(0.33333001)))*l9_70;
}
#else
{
float l9_81;
...
{
l9_81=(1.0-clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0))*l9_70;
}
#else
{
float l9_82;
...
{
l9_82=clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0)*l9_70;
}
#else
{
float l9_83;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_84=clamp(dot(l9_72.xyz,vec3(1.0)),0.0,1.0)*l9_70;
}
#else
{
float l9_85;
...
{
l9_85=dot(l9_72.xyz,vec3(0.33333001))*l9_70;
}
#else
{
float l9_86;
...
#endif
vec3 l9_99=mix(l9_97.xyz,definedBlend(l9_97.xyz,l9_72.xyz).xyz,vec3(l9_70));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_101=vec4(mix(vec3(1.0),l9_72.xyz,vec3(l9_70)),l9_70);
}
#else
{
vec4 l9_102;
